<template>
  <biz-grid class="content-nyqg">
    <biz-save-button slot="top" :operations="operations" @operate="operate" v-if="isEdit">
    </biz-save-button>
    <el-form :rules="rules" ref="form" :model="content" :disabled="!isEdit" label-width="100px" size="small" v-loading="loading">
      ...
      <!-- <el-form-item label="中奖人数">
        <el-input-number disabled
                         placeholder="请输入中奖人数"
                         v-model="content.productCount"></el-input-number>
      </el-form-item> -->
      <el-form-item label="参与人次" prop="maxPersonCount">
        <el-input-number :min="min" placeholder="请输入参与人次" v-model="content.maxPersonCount"></el-input-number>
      </el-form-item>
      <el-form-item label="当前期数">
        <el-input disabled placeholder="" v-model="content.periods"></el-input>
      </el-form-item>
    ...
    <biz-dialog-selector class="content-nyqg-dialog" title="选择商品" :visibility.sync="dialogVisible" :tableData="tableData"
      :pagination="pagination" :selectionMode="'single'" :filters="dialogFilters" @pageSizeChange="handleSizeChange" :isClear="false"
      @currentPageChange="handleCurrentChange" @confirmed="confirmedProduct" @filterDataChange="productFilterDataChange">
    ...
    refresh(activity) {
      ...
      Service.getActivityContent(
        ...
        data => {
          ...
          this.content.luckPersonCount = data.activity.luckPersonCount;
          ...
          this.content.periods = data.activity.periods;
    ...
    save() {
      this.$refs.form.validate(valid => {
        ...
        let params = {
          ...
          luckPersonCount: String(this.content.productCount),
...
.content-nyqg-dialog.biz-dialog-selector {
}
</style>
