  ...
  <biz-grid class="content-ptg">
    ...
    <el-form :rules="rules" ref="form" :model="content" label-width="100px" size="small" :disabled="!isEdit" v-loading="loading">
      ...
      <el-form-item label="团购类型">
        <el-select v-model="content.groupType">
          <el-option :label="type.label" :value="type.value" :key="index" v-for="(type,index) of tgTypeList"></el-option>
        </el-select>
      </el-form-item>
      ...
      <el-form-item label="成团人数" prop="maxPersonCount">
        <el-input-number :min="minhdrs" placeholder="请输入活动人数" v-model="content.maxPersonCount"></el-input-number>
      </el-form-item>
    ...
    refresh(activity) {
      ...
      Service.getActivityContent(
        ...
        data => {
          ...
          this.content.groupType = data.activity.groupType;
    ...
    save() {
      this.$refs.form.validate(valid => {
        ...
        let params = {
          ...
          groupType: this.content.groupType,
