  ...
  <biz-grid class="activity-promotion-mgmt">
    ...
    <div slot="float">
      <biz-popup-tabs :open="openPopup" v-model="popupTabName" @close="openPopup = false;">
        ...
        <!-- <el-tab-pane v-if="!isCreated" label="活动内容" name="content">
          <promotion-content-free-shipping
            ...
            v-if="activePromotion.promotionType === 'FreeShipping'"
          ></promotion-content-free-shipping>
          <promotion-content-discount
            ...
            @updated="contentUpdate"
            :memberRankList="initInfo.memberRankList"
            v-if="activePromotion.promotionType === 'Discount'"
          ></promotion-content-discount>
          <promotion-content-full-cut
            ...
            @updated="contentUpdate"
            :memberRankList="initInfo.memberRankList"
            v-if="activePromotion.promotionType === 'FullCut'"
          ></promotion-content-full-cut>
          <promotion-content-full-gift
            ...
            @updated="contentUpdate"
            :memberRankList="initInfo.memberRankList"
            v-if="activePromotion.promotionType === 'FullGift'"
          ></promotion-content-full-gift>
          <promotion-content-package
            ...
            @updated="contentUpdate"
            :memberRankList="initInfo.memberRankList"
            v-if="activePromotion.promotionType === 'Package'"
          ></promotion-content-package>
          <promotion-content-coupon
            ...
            @updated="contentUpdate"
            :memberRankList="initInfo.memberRankList"
            v-if="activePromotion.promotionType === 'coupon'"
          ></promotion-content-coupon>
          <promotion-content-promotion
            ...
            @updated="contentUpdate"
            :memberRankList="initInfo.memberRankList"
            v-if="activePromotion.promotionType === 'product'"
          ></promotion-content-promotion>
        </el-tab-pane> -->
  ...
  methods: {
    ...
    onViewSwitch(name) {
      ...
      if (this.views[0].actived === true) {
        ...
        this.getPromotionModelList();
      // }
      // if (this.views[3].actived === true) {
      //   // this.filters[1].value = '2';
      ...
      //     { label: '已结束', value: '5' }
      //   ];
      //   this.$set(this.filters[1], 'disabled', true);
      //   this.getStatisticsAnalysis();
      // } else if (name === 'model') {
    ...
    getPromotionList() {
      ...
      PromotionMgmtService.getPromotionList(
        params,
        data => {
          this.loading = false;
    ...
    getPromotionModelList() {
      ...
      modelService.getList(
        params,
        data => {
          this.promotionModelList = data.content;
    ...
    getStatisticsAnalysis() {
      let params = {
        promotionType: this.filters[0].value,
      ...
      this.$nextTick(() => {
        this.$refs.statistics.refresh(params);
      });
    },
    deleted() {
      this.getPromotionList();
    ...
    getActivity(val) {
      let url = '/admin/promotion/promotion.jhtml';
