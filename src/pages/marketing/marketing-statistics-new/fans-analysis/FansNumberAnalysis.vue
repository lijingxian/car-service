<template>
  <div class="fans-number-analysis">
    <div slot="top">
    ...
    <div class="chart-area" v-loading="loading">
        ...
        <div class="filterSeach">
          <div class="filter-area">
            <el-radio-group @change="indicatorChanged" v-model="indicatorValue" size="mini">
              <el-radio-button label="fansNumCnt">累计粉丝数</el-radio-button>
              <!-- <el-radio-button label="1">净增粉丝数</el-radio-button> -->
              <el-radio-button label="fansNumInt">新增粉丝数</el-radio-button>
              <!-- <el-radio-button label="3">取关粉丝数</el-radio-button> -->
            </el-radio-group>
          </div>
      ...
      <biz-list ref="list" :height="height" :tableData="tableData" style="width: 100%;height:100%" v-show="radioValue==='1'">
          ...
          <el-table-column prop="yValue" v-if="indicatorValue==='fansNumInt'" label="新增粉丝数"></el-table-column>
          <el-table-column prop="yValue" v-if="indicatorValue==='fansNumCnt'" label="累计粉丝数"></el-table-column>
        </biz-list>
