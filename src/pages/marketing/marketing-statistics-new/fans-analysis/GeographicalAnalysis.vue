<template>
  <div class="geographical-analysis">
    ...
    <div class="chart-area" v-loading="loading">
      ...
      <biz-list ref="list" :height="height" :tableData="tableData" style="width: 100%;height:100%" v-show="radioValue==='1'">
          <!-- <el-table-column prop="mobile" label="序号"></el-table-column> -->
          <el-table-column prop="province" label="省份"></el-table-column>
          <el-table-column prop="memberNum" label="粉丝数"></el-table-column>
        </biz-list>
        ...
        for (const item of data) {
          for (let i = 0; i < item.children.length; i++) {
            tmpDataByPro.push({
              ...
              人: Number(item.children[i].count)
            });
