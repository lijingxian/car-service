          ...
          indicatorReqs: [
            {
              tables: ['espromotion'],
              calcs: ['count(1)'],
              name: 'promotionVisitNum'
            },
            {
              tables: ['espromotionattend'],
              calcs: ['count(1)'],
              name: 'promotionOrderNum'
            },
            {
              tables: ['espromotionattend'],
              calcs: ['count(1)'],
              name: 'promotionPaymentNum',
              paymentStatuss: ['paid']
            }
          ],
          viewType: this.viewType,
    ...
    dataFormat(data) {
      ...
      if (this.indicatorValue === 'promotion') {
        tmpData = [
          {
            状态: '访问人数',
            数值: data.indicators.promotionVisitNum.increase
          },
          { 状态: '下单人数', 数值: data.indicators.promotionOrderNum.increase },
          { 状态: '付款人数', 数值: data.indicators.promotionPaymentNum.increase }
        ];
      } else {
        tmpData = [
          {
