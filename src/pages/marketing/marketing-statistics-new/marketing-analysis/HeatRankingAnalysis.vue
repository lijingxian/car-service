<template>
  <div class="heat-ranking-analysis">
    <div slot="top">
    ...
    <div class="chart-area" v-loading="loading">
        ...
        <div class="filterSeach">
          <div class="filter-area">
            <el-radio-group @change="indicatorChanged" v-model="indicatorValue" size="mini">
              <el-radio-button label="hotMarketingActivity">热门营销活动</el-radio-button>
              <el-radio-button label="hotPromotionActivity">热门促销活动</el-radio-button>
              <el-radio-button label="marketingHotArticle">热门软文</el-radio-button>
              <el-radio-button label="marketingHotProduct">热门商品宣传</el-radio-button>
            </el-radio-group>
          </div>
      ...
      <biz-list ref="list" :height="height" :tableData="tableData" style="width: 100%;height:100%" v-show="radioValue==='1'">
          ...
          <el-table-column prop="xValue" label="标题"></el-table-column>
          <el-table-column prop="value" label="阅读量"></el-table-column>
        </biz-list>
...
export default {
  ...
  data() {
    return {
      ...
      kpiName: ['本期', '同比', '环比'],
      radioValue: '0',
      indicatorValue: 'hotMarketingActivity'
    };
  },
  props: {
    params: {
