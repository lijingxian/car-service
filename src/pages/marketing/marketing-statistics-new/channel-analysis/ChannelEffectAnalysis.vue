  ...
  <div class="channel-effect-analysis">
    ...
    <div class="chart-area" v-loading="loading">
        ...
        <div class="filterSeach">
          <div class="filter-area">
            <el-radio-group @change="indicatorChanged" v-model="indicatorValue" size="mini">
              <!-- <el-radio-button label="0">展示量</el-radio-button> -->
              <el-radio-button label="channelViewNum">点击量</el-radio-button>
              <!-- <el-radio-button label="2">转化量</el-radio-button> -->
            </el-radio-group>
          </div>
      ...
      <biz-list ref="list" :height="height" :tableData="tableData" style="width: 100%;height:100%" v-show="radioValue==='1'">
          <el-table-column prop="lable" label="渠道"></el-table-column>
          <el-table-column prop="value" label="点击量"></el-table-column>
        </biz-list>
