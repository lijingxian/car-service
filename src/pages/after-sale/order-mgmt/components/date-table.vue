<template>
  <table
    ...
    <tr>
      ...
      <th v-for="week in WEEKS" :key="week.index">{{ t('el.datepicker.weeks.' + week) }}</th>
    </tr>
    <tr
...
<script>
import { getFirstDayOfMonth, getDayCountOfMonth, getWeekNumber, getStartDateOfMonth, nextDate, isDate } from 'element-ui/src/utils/date-util';
