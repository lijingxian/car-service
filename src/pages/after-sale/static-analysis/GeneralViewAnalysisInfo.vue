    ...
    <div class="chart-area">
      <div class="graph">
        ...
        <biz-list ref="list" :height="height" :tableData="tableData" style="width: 100%" v-if="!isShow">
          <el-table-column prop="member.mobile" label="客户手机号"></el-table-column>
          <el-table-column prop="memberName" label="客户姓名"></el-table-column>
          <el-table-column prop="order.completeDate" label="订单完成时间"></el-table-column>
          <el-table-column prop="orderSn" label="商品信息">
            <template slot-scope="scope">
              <div v-for="orderItem in scope.row.order.orderItems" :key="orderItem.id">
                {{orderItem.fullName}}
              </div>
            </template>
          </el-table-column>
          <el-table-column prop="order.amount" label="订单金额（元）"></el-table-column>
          <el-table-column prop="adminName" label="顾问"></el-table-column>
        </biz-list>
