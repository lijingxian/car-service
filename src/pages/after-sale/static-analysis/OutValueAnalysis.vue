    ...
    <div class="chart-area">
      <div class="graph">
        ...
        <biz-list ref="list" :height="height" :tableData="tableData" style="width: 100%" v-if="!isShow">
          <el-table-column prop="member.mobile" label="客户手机号" v-if="filters[0].value!=='2'"></el-table-column>
          <el-table-column prop="member.name" label="客户姓名" v-if="filters[0].value!=='2'"></el-table-column>
          <el-table-column prop="completeDate" label="订单完成时间" v-if="filters[0].value!=='2'"></el-table-column>
          <el-table-column prop="orderItems[0].fullName" label="商品信息" v-if="filters[0].value!=='2'"></el-table-column>
          <el-table-column prop="price" label="订单金额（元）" v-if="filters[0].value!=='2'"></el-table-column>
          <el-table-column prop="consultant.name" label="顾问" v-if="filters[0].value!=='2'"></el-table-column>
          <el-table-column prop="xValue" label="车型" v-if="filters[0].value==='2'"></el-table-column>
          <!-- <el-table-column prop="yValue" label="销售台次（台）" v-if="filters[0].value==='2'"></el-table-column> -->
          <el-table-column prop="yValue" label="销售金额（万元）" v-if="filters[0].value==='2'"></el-table-column>
          <!-- <el-table-column prop="orderTime" label="时间" v-if="filters[0].value==='2'"></el-table-column> -->
        </biz-list>
...
export default {
  ...
  methods: {
      ...
      http
        ...
        .then(data => {
          if (this.filters[0].value === '2') {
            this.chartData = this.dataTimesFormat(data);
          } else {
    ...
    getTable() {
      ...
      http
        .post('/admin/ecommerce/kpi/afterSales/table.jhtml', params)
        .then(data => {
