    ...
    <div class="chart-area">
      <div class="graph">
        ...
        <biz-list ref="list" :height="height" :tableData="tableData" style="width: 100%" v-if="!isShow">
          ...
          <el-table-column prop="member.name" label="客户姓名"></el-table-column>
          <el-table-column prop="completeDate" label="订单完成时间"></el-table-column>
          <el-table-column prop="orderItems[0].fullName" label="商品信息"></el-table-column>
          <el-table-column prop="price" label="订单金额（元）"></el-table-column>
          <el-table-column prop="consultant.name" label="顾问"></el-table-column>
        </biz-list>
