    ...
    <div class="chart-area">
      <div class="graph">
        ...
        <biz-list ref="list" :height="height" :tableData="tableData" style="width: 100%" v-if="!isShow">
          ...
          <el-table-column prop="yValue" label="接待台次（台）" v-if="filters[0].value==='0'"></el-table-column>
          <el-table-column prop="yValue" label="售后收入（万元）" v-if="filters[0].value==='1'"></el-table-column>
        </biz-list>
