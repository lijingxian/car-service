<template>
  <div class="brand-series-mgmt">
    <biz-flex-table :loading="loading" ref="table" :operations="operations" @operate="operate" :tableData="tableData"
      ...
      @size-change="handleSizeChange" @current-change="handleCurrentChange" :rowKeys="rowKeys" >
  ...
  methods: {
    ...
    getKpi() {
      http
        ...
        .then(data => {
          let msg = '您可创建或者导入品牌及系列，当前已维护品牌' + data.data.shopBrandsCount + '个';
          this.$message({
