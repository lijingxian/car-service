<template>
  <biz-grid class="commodity-mgmt-picture-info">
    ...
    <el-form ref="form" size="small" :rules="rules" label-position="top" label-width="110px" :disabled="!isEdit">
      ...
      <!-- <el-form-item label="VR资源管理">
        ...
        <ProductVrFileUploader :open="open" :fileList="vrFileList" :productId="id" :isTestDrive="false" @upload-success="handleVRUpload"
    ...
    <el-dialog :visible="previewDialogOpen" append-to-body :open="previewDialogOpen" @close="previewDialogOpen=false" width="420px">
      <iframe :src="'resources/admin/ecStatic/index.html?#/vshop/goods/'+id+'?shopId='+baseInfo.shopId" frameborder="0" scrolling="no"
        width="375px" height="567px"></iframe>
    </el-dialog>
