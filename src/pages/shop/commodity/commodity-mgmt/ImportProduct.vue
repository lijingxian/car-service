<template>
  <biz-grid class="lead-base-info-i-product" v-loading="loading">
            ...
            <div class="category-select">
              <el-form label-width="120px" size="small">
                <el-form-item label="分类" prop="topProductCategoryId">
                  ...
                  <el-select v-model="subProductCategoryId" placeholder="请选择二级分类" @change="subCategoryChange"
                    v-show="subCategoryOptions.length !== 0">
...
export default {
  ...
  methods: {
    ...
    conditionChange() {
      ...
      console.log(123);
      if (this.seriesId.length === 0 && this.categoryType === 'car') {
        this.modeList = [];
        return;
      }
      let params = {
