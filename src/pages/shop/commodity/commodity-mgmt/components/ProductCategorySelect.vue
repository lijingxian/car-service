  ...
  <div class="product-category-select">
    <el-form label-width="150px" size="small">
      ...
      <el-form-item label="名称：" :required="true">
        <el-autocomplete type="textarea" :rows="3" :maxlength="30" show-word-limit :value="name" :fetch-suggestions="querySearchAsync" placeholder="请输入名称" @input="onInputName" @select="selectName"></el-autocomplete>
      </el-form-item>
    </el-form>
  </div>
</template>
