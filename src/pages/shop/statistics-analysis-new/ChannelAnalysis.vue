  ...
  <div class="general-view-analysis-info">
    ...
    <div class="chart-area">
      <div class="graph">
        ...
        <biz-chart :chartData="chartDataPie" :loading="loading" :showSearch="false" v-if="radioValue==='0'&&filters[0].value==='transformationRate'"></biz-chart>
        <!-- <biz-list ref="list" :height="height" :tableData="tableData" style="width: 100%" v-if="!isShow">
          ...
          <el-table-column prop="viewNum" label="浏览人数"></el-table-column>
          <el-table-column prop="consumeNum" label="购买人数"></el-table-column>
          <el-table-column prop="transformationRate" label="转化率"></el-table-column>
          <el-table-column prop="" label="收藏人数"></el-table-column>
          <el-table-column prop="" label="加购人数"></el-table-column>
        </biz-list>
      ...
      filters: [
        {
          ...
          value: 'viewNum',
          options: [
            { value: 'viewNum', label: '浏览人数' },
            { value: 'consumeNum', label: '购买人数' },
            { value: 'transformationRate', label: '转化率' }
          ]
        }
      ],
      kpiName: ['本期', '同比', '环比'],
  ...
  methods: {
    ...
    getGraphData() {
      ...
      http
        ...
        .then(data => {
          // if (this.filters[0].value !== 'transformationRate') {
    ...
    dataFormatPie(data) {
      ...
      for (let i = 0; i < data.indicators.length; i++) {
        tmpData.push({
          ...
          数量: data.indicators[i].yValue / 100
        });
      }
      let chartData = {
        legendVisible: false,
