<template>
  <div class="insurance-company-mgmt">
    ...
    <insurance-company-mgmt-popup slot="float" :open="openPopup" @close="closePopup" :id="id4Popup" @refreshNotification="refresh" @addSuccessNotification="addSuccess"></insurance-company-mgmt-popup>
  </div>
</template>

<script>
import { BizFlexTable } from '@/components/BizTable';
import InsuranceCompanyMgmtPopup from './InsuranceCompanyMgmtPopup';
