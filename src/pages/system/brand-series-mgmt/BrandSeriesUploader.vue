<template>
  <div class="brand-series-uploader">
    <el-upload ref="upload" :show-file-list="false" accept="image/*" class="avatar-uploader" :style="avatarStyle" name="file" :on-success="handleSuccess"
      action="/admin/file/uploads.jhtml" :data="fileData">
