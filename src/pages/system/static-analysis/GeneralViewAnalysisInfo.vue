    ...
    <div class="chart-area">
      <div class="graph">
        ...
        <biz-list ref="list" :height="height" :tableData="tableData" style="width: 100%" v-if="!isShow">
          <el-table-column prop="statisticsColumnDatas[0].columnValue" label="日期" v-if="filters[0].value!=='5'"></el-table-column>
          <el-table-column prop="statisticsColumnDatas[1].columnValue" label="渠道" v-if="filters[0].value==='channel'"></el-table-column>
          <el-table-column prop="statisticsColumnDatas[1].columnValue" label="浏览人数" v-if="filters[0].value==='view'"></el-table-column>
          <el-table-column label="分享人数" prop="statisticsColumnDatas[1].columnValue" min-width="180" v-if="filters[0].value==='share'">
          </el-table-column>
          <el-table-column prop="statisticsColumnDatas[1].columnValue" label="点击人数" v-if="filters[0].value==='click'"></el-table-column>
          <el-table-column prop="statisticsColumnDatas[1].columnValue" label="时间范围" v-if="filters[0].value==='5'">
          </el-table-column>
        </biz-list>
...
export default {
      ...
      filters: [
        {
          ...
          value: 'view',
          options: [
            { value: 'view', label: '浏览人数', type: 'car' },
            { value: 'share', label: '分享人数', type: 'car' },
            { value: 'click', label: '点击人数', type: 'car' },
            { value: 'channel', label: '渠道', type: 'car' },
            { value: '5', label: '浏览时间', type: 'car' }
            // { value: 'customerDriveIns', label: '人均销售台次' }
          ]
        }
      ],
      kpiName: ['本期', '同比', '环比'],
  ...
  methods: {
    ...
    getTable() {
      let params = {};
      if (this.filters[0].value === 'channel') {
        params = {
          group: ['year_month_name', 'channel_name'],
          table: ['dw_operation_log'],
          sort: ['operate_date'],
          page: {
