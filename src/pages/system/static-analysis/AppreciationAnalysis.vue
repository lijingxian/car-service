  ...
  <div class="general-view-analysis-info">
    ...
    <div class="chart-area">
      <div class="graph">
        ...
        <biz-list ref="list" :height="height" :tableData="tableData" style="width: 100%" v-if="!isShow&&filters[0].value==='1'">
          ...
          <el-table-column label="订购时间" prop="statisticsColumnDatas[8].columnValue" min-width="180">
          </el-table-column>
        </biz-list>
        <biz-list ref="list" :height="height" :tableData="tableData" style="width: 100%" v-if="!isShow&&filters[0].value==='0'">
          <el-table-column prop="statisticsColumnDatas[0].columnValue" label="用户"></el-table-column>
          <el-table-column prop="statisticsColumnDatas[1].columnValue" label="点击次数"></el-table-column>
        </biz-list>
      ...
      filters: [
        {
          ...
          value: '0',
          options: [
            { value: '0', label: '服务介绍', type: 'product' },
            { value: '1', label: '新增服务', type: 'finance' }
          ]
        }
      ],
      kpiName: ['本期', '同比', '环比'],
