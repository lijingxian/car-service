    ...
    <div class="chart-area">
      <div class="graph">
        ...
        <biz-list ref="list" :height="height" :tableData="tableData" style="width: 100%" v-if="!isShow">
          ...
          <el-table-column prop="statisticsColumnDatas[5].columnValue" label="服务名称" v-if="filters[0].value==='0'||filters[0].value==='1'"></el-table-column>
          <el-table-column prop="statisticsColumnDatas[6].columnValue" label="订购时间" v-if="filters[0].value==='0'||filters[0].value==='1'"></el-table-column>
          <el-table-column prop="statisticsColumnDatas[13].columnValue" label="订购时长（个月）" v-if="filters[0].value==='0'||filters[0].value==='1'"></el-table-column>
          <el-table-column prop="statisticsColumnDatas[1].columnValue" label="平均在线时长" v-if="filters[0].value!=='0'&&ilters[0].value!=='1'"></el-table-column>
          <el-table-column prop="statisticsColumnDatas[2].columnValue" label="平均登入次数" v-if="filters[0].value!=='0'&&ilters[0].value!=='1'"></el-table-column>
          <el-table-column prop="statisticsColumnDatas[2].columnValue" label="模块平均使用时长" v-if="filters[0].value!=='0'&&ilters[0].value!=='1'"></el-table-column>
          <el-table-column prop="statisticsColumnDatas[2].columnValue" label="功能平均使用时长" v-if="filters[0].value!=='0'&&ilters[0].value!=='1'"></el-table-column>
        </biz-list>
      ...
      filters: [
        {
          ...
          value: '0',
          options: [
            { value: '0', label: '服务订购分布', type: 'car' },
            // { value: '1', label: '服务订购时长', type: 'car' },
            { value: '2', label: '模块使用情况', type: 'car' },
            { value: '3', label: '功能使用情况', type: 'car' }
            // { value: '4', label: '在线时长', type: 'car' },
            // { value: '5', label: '登入', type: 'car' }
          ]
        }
      ],
      kpiName: ['本期', '同比', '环比'],
  ...
  methods: {
    ...
    getGraphData() {
      ...
      http
        ...
        .then(data => {
          if (this.filters[0].value === '1') {
            this.chartData = this.dataFormatH(data);
          } else {
