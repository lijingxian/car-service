    ...
    <div class="chart-area">
      <div class="graph">
        ...
        <biz-list ref="list" :height="height" :tableData="tableData" style="width: 100%" v-if="!isShow">
          <el-table-column prop="statisticsColumnDatas[21].columnValue" label="渠道"></el-table-column>
          <el-table-column prop="statisticsColumnDatas[11].columnValue" label="地域"></el-table-column>
          <el-table-column prop="statisticsColumnDatas[4].columnValue" label="注册用户"></el-table-column>
        </biz-list>
...
export default {
      ...
      filters: [
        {
          ...
          value: 'province_name',
          options: [
            { value: 'province_name', label: '地域分布', type: 'car' },
            // { value: 'channel_name', label: '渠道', type: 'car' },
            { value: 'year_month_name', label: '注册人数', type: 'car' }
            // { value: 'customerCnt', label: '人均销售收入' }
          ]
        }
      ],
      kpiName: ['本期', '同比', '环比'],
  ...
  methods: {
    ...
    getGraphData() {
      this.loading = true;
      let params = {
        group: [this.filters[0].value],
        sort: [this.filters[0].value + ' ' + 'desc'],
        ...
        showColumn: [
          {
            fieldName: this.filters[0].value
          },
          {
            formula: 'count(1)',
            as: 'num'
      ...
      http
        ...
        .then(data => {
          if (this.filters[0].value === 'year_month_name') {
