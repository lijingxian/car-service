<template>
  <biz-grid class="payment-mgmt-base-info">
    ...
    <el-form
      ...
      v-loading="loading"
    >
      <el-form-item label="收款单号" prop="sn">
        <el-input placeholder="" v-model="form.sn"></el-input>
      </el-form-item>
      <el-form-item label="付款人" prop="memberData">
        <el-input placeholder="" v-model="form.memberData.name"></el-input>
      </el-form-item>
      ...
      <el-form-item label="付款日期" prop="paymentDate">
        <el-date-picker value-format="yyyy-MM-dd" placeholder="" v-model="form.paymentDate"></el-date-picker>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    refresh() {
      ...
      http.get(financeMgmt.payment.baseInfo.query, params)
        .then(
          data => {
            this.loading = false;
    ...
    create() {
      ...
      http.post(financeMgmt.payment.baseInfo.create, params)
        .then(
          data => {
            this.loading = false;
    ...
    update() {
      ...
      http.put(financeMgmt.payment.baseInfo.update, params)
        .then(
          data => {
            this.loading = false;
            this.$message.success('操作成功');
