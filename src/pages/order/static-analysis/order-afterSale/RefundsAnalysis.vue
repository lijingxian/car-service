    ...
    <div class="chart-area">
      <div class="graph">
        ...
        <biz-list ref="list" :height="height" :tableData="tableData" style="width: 100%" v-if="!isShow">
          ...
          <el-table-column prop="yValue" label="售后退款次数" v-if="filters[0].value==='afterSaleRefundNum'"></el-table-column>
          <el-table-column prop="yValue" label="退款总金额" v-if="filters[0].value==='afterSaleRefundAmount'"></el-table-column>
          <el-table-column prop="yValue" label="售后率" v-if="filters[0].value==='afterSaleRefundRate'"></el-table-column>
      ...
      filters: [
        {
          type: 'single',
          label: '',
          value: 'afterSaleRefundNum',
          options: [
            { value: 'afterSaleRefundNum', label: '售后退款次数' },
            { value: 'afterSaleRefundAmount', label: '退款总金额' },
            { value: 'afterSaleRefundRate', label: '售后率' }
          ]
        }
      ],
      kpiName: ['本期', '同比', '环比'],
