<template>
  <div class="general-view-analysis-rescue">
    <div slot="top">
    ...
    <div class="chart-area">
      <div class="graph">
        ...
        <biz-list ref="list" :height="height" :tableData="tableData" style="width: 100%" v-if="!isShow">
          ...
          <el-table-column prop="resueName" label="救援项目"></el-table-column>
          <el-table-column prop="resueWay" label="呼叫方式"></el-table-column>
        </biz-list>
      ...
      filters: [
        {
          ...
          label: '',
          value: 'resueItem',
          options: [{ value: 'resueItem', label: '救援项目' }, { value: 'callMode', label: '呼叫方式' }]
        }
      ],
      kpiName: ['本期', '同比', '环比'],
      chartData: {},
