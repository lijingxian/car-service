  ...
  <biz-grid class="finance-order-base-info">
    ...
    <el-form ref="form" :model="form" label-width="120px" size="small" v-loading="loading" :disabled="!isEdit" :inline-message="true">
      ...
      <el-form-item label="调整金额" prop="offsetAmount" v-if="showInfo">
        <el-input-number v-model="form.offsetAmount" controls-position="right" :disabled="itemId!==''&&form.paymentStatus==='2'||form.type==='订单关闭'"
          @change="offsetAmountChange"></el-input-number>
      </el-form-item>
      ...
      <el-collapse v-model="activeNames">
        <el-collapse-item name="1">
          ...
          <el-form-item label="会员昵称" prop="member.nickname" class="isRequired">
            <el-input v-model="form.member.nickname" :disabled="itemId?true:false" @focus="showDialog = true;" placeholder="请选择或添加会员">
        ...
        <el-collapse-item name="2" v-if="this.$route.params.orderType==='finance'">
          ...
          <el-form-item label="意向商品分期" prop="orderItems[0].appointment.product.brandId" class="isRequired">
            <el-select v-model="form.orderItems[0].appointment.product.brandId" placeholder="请选择品牌" filterable style="width: 100%;"
          ...
          <el-form-item label="" prop="orderItems[0].appointment.product.seriesId" class="isRequired">
            <el-select v-model="form.orderItems[0].appointment.product.seriesId" placeholder="请选择系列" filterable style="width: 100%;"
          ...
          <el-form-item label="" prop="orderItems[0].appointment.product.id" class="isRequired">
            <el-select v-model="form.orderItems[0].appointment.product.id" placeholder="请选择车型" style="width: 100%;" @change="productChange"
              class="isRequired">
          ...
          <el-form-item label="金融方案" prop="orderItems[0].appointment.financialPlan.id">
            <el-select v-model="form.orderItems[0].appointment.financialPlan.id" @change="loanTerm(form.orderItems[0].appointment.financialPlan.id)"
              placeholder="请选择金融方案">
          ...
          <el-form-item label="分期期数" prop="orderItems[0].appointment.year">
            <el-select v-model="form.orderItems[0].appointment.year" placeholder="请选择还款年限" @change="monthPay">
              <el-option v-for="(loanTerm,index) in form.orderItems[0].appointment.financialPlan.loanTerms" :key="index" :label="loanTerm.year+'年'"
                :value="loanTerm.year"></el-option>
            </el-select>
          </el-form-item>
          ...
          <el-form-item label="首付">
            <el-input :value="form.orderItems[0].appointment.product.price?form.orderItems[0].appointment.product.price*form.orderItems[0].appointment.downPayment/100:form.orderItems[0].appointment.product.price"
        ...
        <el-collapse-item name="3" title="投保资料" v-if="this.$route.params.orderType==='insurance'">
          ...
          <el-form-item label="注册日期">
            <el-date-picker v-model="form.orderItems[0].appointment.appontmentDate" format="yyyy-MM-dd" value-format="yyyy-MM-dd HH:mm:ss"
              type="date" placeholder="请选择注册日期">
            </el-date-picker>
          </el-form-item>
        </el-collapse-item>
        ...
        <el-collapse-item name="5" v-if="showInfo">
          ...
          <el-form-item label="付款银行" prop="payments[0].payBank" v-if="form.payments[0].paymentType==='刷卡'||form.payments[0].paymentType==='汇款'"
            class="isRequired">
          ...
          <el-form-item label="付款帐号" prop="payments[0].payAccount" v-if="form.payments[0].paymentType==='刷卡'||form.payments[0].paymentType==='汇款'"
            class="isRequired">
        ...
        <el-collapse-item title="优惠信息" name="6" v-if="showInfo">
          ...
          <div v-else>
            ...
            <el-form-item label="V豆抵扣" prop="beanDiscount">
              <el-input v-model="form.beanDiscount" :disabled="!(form.payments[0].paymentType==='会员卡余额'&&form.memberCardId&&form.bean)"
                @change="beanChange" :min="0"></el-input>
    ...
    <biz-dialog-selector title="选择会员" :visibility.sync="showDialog" :appendToBody="true" :keyField="'id'" :selectionKeys="selectionKeys"
      :loading="dialogLoading" :tableData="dialogTableData" :pagination="dialogPagination" :selectionMode="'single'" :filters="dialogFilters"
      @confirmed="handleConfirmed" @open="opened" @operate="dialogOperate" @filterDataChange="dialogFilterDataChange"
    ...
    <biz-dialog-selector title="选择车型" :visibility.sync="showProductSelector" :tableData="productTableData" :pagination="productPagination"
