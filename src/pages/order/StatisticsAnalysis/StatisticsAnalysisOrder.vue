    ...
    <biz-chart :chartData="chartData" :filters="filters" @filterDataChange="filterDataChange" :loading="loading" :pagination="pagination"
      ...
      <div slot="list">
        <biz-list ref="list" :height="height" :tableData="tableData" style="width: 100%">
          ...
          <!-- <el-table-column prop="satisfaction" label="客户满意度（分）">
          </el-table-column> -->
        </biz-list>
      </div>
      <div slot="description">
        <p>当期订单数：统计期内订单状态变更为“交易完成”的订单的数量</p>
        <p>累计订单数：自然年内，截止至统计选择期，订单状态变更为“交易完成”的订单数总计</p>
        <p>当期订单金额：统计期内订单状态变更为“交易完成”的订单的实付金额总计—统计期内退款金额总计</p>
        <p>累计订单金额：自然年内，截止至统计选择期，订单状态变更为“交易完成”的订单金额总计</p>
      </div>
    </biz-chart>
  </div>
</template>
