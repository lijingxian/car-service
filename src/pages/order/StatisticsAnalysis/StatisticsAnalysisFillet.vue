  ...
  <div class="marketing-statistics-activity-kpi-report">
    <biz-chart :chartData="chartData" :filters="filters" @filterDataChange="filterDataChange" :loading="loading" :pagination="pagination"
      ...
      <div slot="description">
        <p>当期订单数：统计期内订单状态变更为“交易完成”，订单中商品分类为--汽车内饰、汽车电子、汽车改装、汽车外饰、汽车配件订单的数量</p>
        <p>累计订单数：自然年内，截止至统计选择期，订单数总计</p>
        <p>当期精品产值：统计期内订单状态变更为“交易完成”&订单中商品分类为--汽车内饰、汽车电子、汽车改装、汽车外饰、汽车配件的订单的实付金额总计—统计期内退款金额总计</p>
        <p>累计订精品产值：自然年内，截止至统计选择期，订单金额总计</p>
      </div>
    </biz-chart>
  </div>
</template>
      ...
      filters: [
        {
          ...
          options: [
            ...
            { value: 'orderAmount', label: '当期精品产值' },
            {
