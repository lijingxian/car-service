...
export default {
  ...
  computed: {
    ...
    ...mapGetters('CustomService', ['csData', 'csList', 'groupList', 'onlineList'])
  },
  methods: {
    ...mapMutations('CustomService', ['updateUserKetword', 'updateCsData', 'pushRoom', 'makeAactivatedRoom']),
    ...mapActions('CustomService', ['getHistoryList']),
    switchVoice() {
