<template>
  <div class="im-chat-list">
    <div class="wrapper" ref="wrapper-ref">
      ...
      <im-chat-item v-for="message of room.messageList" :key="message.id" :message="message" @product="onProduct"></im-chat-item>
    </div>
  </div>
</template>
...
export default {
  ...
  created() {},
  mounted() {
    console.log(this.room.messageList);
    setTimeout(() => {
  ...
  methods: {
    ...mapMutations('CustomService', ['increasePageNumberAndInit']),
    onProduct(id) {
