  ...
  <div class="snt-analysis">
    <div slot="top">
      <show-search-grid @refreshHandle="refreshHandle" ref="search">
        <div slot="description" class="description-pover">
          <p>服务满意度评分：筛选范围内机器人服务满意度评分</p>
          <p>响应速度评分：筛选范围内机器人响应速度评分</p>
          <p>任务达成评分：筛选范围内机器人任务达成评分</p>
        </div>
      </show-search-grid>
    </div>
    ...
    <div class="chart-area" v-loading="loading">
        ...
        <div class="filterSeach">
          <div class="filter-area">
            <el-radio-group @change="indicatorChanged" v-model="indicatorValue" size="mini">
              ...
              <el-radio-button label="serviceAttitude">服务满意度评分</el-radio-button>
              <el-radio-button label="serviceSpeed">响应速度评分</el-radio-button>
              <el-radio-button label="professional">任务达成评分</el-radio-button>
            </el-radio-group>
          </div>
      ...
      <biz-list ref="list" :height="height" :tableData="tableData" style="width: 100%;height:100%" v-show="radioValue==='1'">
          <el-table-column prop="robot" label="机器人"></el-table-column>
          <el-table-column prop="name" label="会员姓名"></el-table-column>
          <el-table-column prop="serviceAttitude" label="服务满意度"></el-table-column>
          <el-table-column prop="professional" label="任务达成"></el-table-column>
          <el-table-column prop="serviceSpeed" label="响应速度"></el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      countTotal: 0,
      radioValue: '0',
      indicatorValue: 'serviceAttitude'
    };
  },
  props: {
    params: {
