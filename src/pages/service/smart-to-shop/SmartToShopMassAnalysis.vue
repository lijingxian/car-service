  ...
  <div class="smtop-analysis">
    ...
    <div class="chart-area" v-loading="loading">
      <div class="graph">
        <div class="filterSeach">
          <div class="filter-area">
            <el-radio-group @change="indicatorChanged" v-model="indicatorValue" size="mini">
              ...
              <el-radio-button label="alarmIns">异常到店数</el-radio-button>
              <el-radio-button label="receptionDuration">服务时长</el-radio-button>
              <el-radio-button label="alarmRate">异常到店率</el-radio-button>
        ...
        <biz-chart :chartData="chartData" :loading="loading" :showSearch="false" v-if="radioValue==='0'&&indicatorValue!=='atShopTime'"></biz-chart>
        <biz-chart :chartData="chartDataOfWork" :loading="loading" :showSearch="false" v-if="radioValue==='0'&&indicatorValue==='atShopTime'"></biz-chart>
  ...
  methods: {
    ...
    getGraphData() {
      ...
      http
        ...
        .then(data => {
          if (this.indicatorValue === 'atShopTime') {
