<template>
  <div class="search-property">
    ...
    <div>
      ...
      <el-date-picker type="daterange" class="biz-date-range" v-model="defaultDate" size="mini" range-separator="至"
        start-placeholder="开始日期" end-placeholder="结束日期" value-format="yyyy-MM-dd" @change="dateChange" :clearable="false"></el-date-picker>
    </div>
