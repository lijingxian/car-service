  ...
  <div class="top-analysis">
    ...
    <div class="chart-area">
        ...
        <div class="filterSeach">
          <div class="filter-area">
            <el-radio-group @change="indicatorChanged" v-model="indicatorValue" size="mini">
              <el-radio-button label="memberTop">成员数排行</el-radio-button>
              <!-- <el-radio-button label="1">签到数排行</el-radio-button> -->
            </el-radio-group>
          </div>
      ...
      <biz-list ref="list" :height="height" :tableData="tableData" style="width: 100%;height:100%" v-show="radioValue==='1'">
          ...
          <el-table-column prop="xValue" label="车友会名称"></el-table-column>
          <el-table-column prop="yValue" label="成员数"></el-table-column>
        </biz-list>
