  ...
  <div class="hot-analysis">
    ...
    <div class="chart-area" v-loading="loading">
        ...
        <div class="filterSeach">
          <div class="filter-area">
            <el-radio-group @change="indicatorChanged" v-model="indicatorValue" size="mini">
              <el-radio-button label="carBrandIns">搜索</el-radio-button>
              <el-radio-button label="carPriceIns">阅读</el-radio-button>
              <el-radio-button label="carAgeIns">评论</el-radio-button>
              <el-radio-button label="carAddressIns">点赞</el-radio-button>
              <el-radio-button label="carAddressIns">转发</el-radio-button>
            </el-radio-group>
          </div>
      ...
      <biz-list ref="list" :height="height" :tableData="tableData" style="width: 100%;height:100%" v-show="radioValue==='1'">
          ...
          <el-table-column prop="carType" label="标题"></el-table-column>
          <el-table-column prop="price" label="类型"></el-table-column>
