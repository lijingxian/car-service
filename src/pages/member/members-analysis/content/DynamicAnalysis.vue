  ...
  <div class="dynamic-analysis">
    ...
    <div class="chart-area" v-loading="loading">
        ...
        <div class="filterSeach">
          <div class="filter-area">
            <el-radio-group @change="indicatorChanged" v-model="indicatorValue" size="mini">
              <el-radio-button label="viewNum">阅读量</el-radio-button>
              <el-radio-button label="likeNum">点赞数</el-radio-button>
              <el-radio-button label="commentNum">评论数</el-radio-button>
              <!-- <el-radio-button label="carAddressIns">转发数</el-radio-button>
              <el-radio-button label="carAddressIns">平均停留时长</el-radio-button> -->
            </el-radio-group>
          </div>
      ...
      <biz-list ref="list" :height="height" :tableData="tableData" style="width: 100%;height:100%" v-show="radioValue==='1'">
          ...
          <el-table-column prop="readCount" label="阅读量" v-if="indicatorValue==='viewNum'"></el-table-column>
          <el-table-column prop="supportCount" label="点赞数" v-if="indicatorValue==='likeNum'"></el-table-column>
          <el-table-column prop="commentCount" label="评论数" v-if="indicatorValue==='commentNum'"></el-table-column>
        </biz-list>
