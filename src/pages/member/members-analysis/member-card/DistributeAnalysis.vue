<template>
  <div class="dis-analysis">
    <div slot="top">
      <show-search-grid @refreshHandle="refreshHandle" ref="search">
        <div slot="description" class="description-pover">
          <p>消费能力：会员卡对应的会员的消费能力分布（强、较强、中等、较弱、弱）</p>
          <p>价格敏感度：会员卡对应的会员的价格敏感度分布（高、较高、中等、较低、低）</p>
          <p>消费品质：会员卡对应的会员的消费品质分布（高、较高、中等、较低、低）</p>
        </div>
      </show-search-grid>
    </div>
    ...
    <div class="chart-area" v-loading="loading">
      <div class="graph">
        <div class="filterSeach">
          <div class="filter-area">
            <el-radio-group @change="indicatorChanged" v-model="indicatorValue" size="mini">
              <el-radio-button label="0">消费能力</el-radio-button>
              <el-radio-button label="1">价格敏感度</el-radio-button>
              <el-radio-button label="2">消费品质</el-radio-button>
            </el-radio-group>
          </div>
        ...
        <biz-chart :chartData="chartDataOfWork" :loading="loading" :showSearch="false" v-if="radioValue==='0'"></biz-chart>
      <biz-list ref="list" :height="height" :tableData="tableData" style="width: 100%;height:100%" v-show="radioValue==='1'">
          ...
          <el-table-column prop="tagName" :label="indicatorValue==='0'?'消费能力':indicatorValue==='1'?'价格敏感度':'消费品质'"></el-table-column>
        </biz-list>
