  ...
  <div class="amount-analysis">
    <div slot="top">
      <show-search-grid @refreshHandle="refreshHandle" ref="search">
        <div slot="description" class="description-pover">
          <p>会员卡消费：统计范围内会员卡消费的金额总和</p>
          <p>会员卡储值：统计范围内会员卡储值的金额总和</p>
        </div>
      </show-search-grid>
    </div>
    ...
    <div class="chart-area" v-loading="loading">
        ...
        <div class="filterSeach">
          <div class="filter-area">
            <el-radio-group @change="indicatorChanged" v-model="indicatorValue" size="mini">
              <el-radio-button label="0">会员卡消费</el-radio-button>
              <el-radio-button label="1">会员卡储值</el-radio-button>
            </el-radio-group>
          </div>
      ...
      <biz-list ref="list" :height="height" :tableData="tableData" style="width: 100%;height:100%" v-show="radioValue==='1'">
          <el-table-column prop="xValue" label="日期"></el-table-column>
          <el-table-column prop="yValue" :label="indicatorValue==='0'?'消费金额':'储值金额'"></el-table-column>
          <el-table-column prop="yoyRate" label="同比"></el-table-column>
          <el-table-column prop="momRate" label="环比"></el-table-column>
        </biz-list>
