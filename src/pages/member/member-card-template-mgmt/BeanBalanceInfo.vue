<template>
  <div>
    ...
    <el-dialog title="V豆获取量详情" :visible.sync="visibleGet" append-to-body custom-class="usedListInfo">
    ...
    <el-dialog title="V豆使用详情" :visible.sync="visibleUse" append-to-body custom-class="usedListInfo">
      <biz-header :operations="operations" @operate="operate" :filters="filtersInfo" @filterDataChange="filterDataChange"
        @cascader-change="cascaderChange">
      </biz-header>
    ...
    <el-dialog title="V豆余额详情" :visible.sync="visibleBalance" append-to-body custom-class="usedListInfo">
