  ...
  <div class="general-view-analysis-info">
    ...
    <div class="chart-area">
      <div class="graph">
        ...
        <div class="content" style="width:40%;float:right;line-height:40px;font-size: 13px;padding:100px;height:70vh;overflow:auto" v-if="filters[0].value==='accounttOutDistrubute'&&isShow">
        ...
        <biz-chart :chartData="chartDataOfReason" :loading="loading" :showSearch="false"
           v-if="filters[0].value==='accounttOutDistrubute'&&isShow"></biz-chart>
        <biz-chart :chartData="chartData" :loading="loading" :showSearch="false" v-if="isShow&&filters[0].value==='accountOutTrend'"></biz-chart>
        <biz-list ref="list" :height="height" :tableData="tableData" style="width: 100%" v-if="!isShow">
          ...
          <el-table-column prop="paymentDate" label="付款时间"></el-table-column>
      ...
      filters: [
        {
          type: 'single',
          label: '',
          value: 'accountOutTrend',
          options: [
            { value: 'accountOutTrend', label: '支出趋势' },
            { value: 'accountOutDistrubute', label: '业务占比' }
          ]
        }
      ],
      kpiName: ['本期', '同比', '环比'],
  ...
  methods: {
    ...
    getGraphData() {
      ...
      http
        ...
        .then(data => {
          if (this.filters[0].value === 'accountOutTrend') {
