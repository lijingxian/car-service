<template>
  <biz-grid class="invoice-info-receipt-mgmt" v-loading="loading" style="padding-top:0px !important">
    <!-- Button -->
    <biz-header :operations="operations" @operate="handleOperate" v-if="isEdit&&judgeState">
    ...
    <el-dialog :visible.sync="showLogisticsFollowing" center append-to-body custom-class="close-follow-dialog" title="物流跟踪">
