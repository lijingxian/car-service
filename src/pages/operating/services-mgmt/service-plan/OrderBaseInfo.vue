...
export default {
  ...
  data() {
    return {
      ...
      loading: false,
      dialogVisible: false,
      operations: [{ label: '加入订阅清单', name: 'jion', type: 'primary', disabled: false }, { label: '立即订阅', name: 'subscribe', type: 'primary', disabled: false }],
      rules: {
  ...
  methods: {
    ...
    queryPromotion() {
      ...
      http.get('/admin/businessOrder/productCoupons.jhtml', params)
        .then(data => {
