  ...
  methods: {
    ...
    query() {
      ...
      http
        ...
        .then(data => {
          this.productDatas = data.productData.specifications;
          this.$nextTick(() => {
    ...
    querySms() {
      ...
      http
        ...
        .then(data => {
          this.productDatas = data.data.BusinessSpecifications;
          this.$nextTick(() => {
            this.isCreated = false;
            this.isSetting = false;
          });
    ...
    save() {
      ...
      http
        .put('/admin/businessProduct/businessSpecification/v201901.jhtml', params)
        .then(data => {
