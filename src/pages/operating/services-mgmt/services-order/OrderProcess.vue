    ...
    getList() {
      ...
      service.viewOrderlogs(
        ...
        data => {
          ...
          this.amountpaid = data.payments.length > 1 ? Number(data.payments[0].amount) + Number(data.payments[1].amount) : '';
          this.shippings = data.shippings && data.shippings[0];
          this.paymentType = data.payments.length ? data.payments[0].paymentType : '';
          ...
          this.deliveryCorp = data.shippings.length ? data.shippings[0].logistics : '';
          this.trackingNo = data.shippings.length ? data.shippings[0].expressSn : '';
          this.operator = data.shippings.length ? data.shippings[0].consignee : '';
          ...
          if (this.currentState === 'create' || this.currentState === 'confirm') {
            this.active = '1';
          } else if (this.currentState === 'service' || this.currentState === 'shipping') {
            this.active = '2';
