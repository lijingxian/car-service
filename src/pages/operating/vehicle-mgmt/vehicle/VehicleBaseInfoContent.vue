      ...
      <el-collapse v-model="activeNames">
        <el-collapse-item title="基本信息" name="1">
          ...
          <el-form-item label="系列">
            <el-select v-model="formModel.series" placeholder="请选择系列" filterable style="width: 100%;" @change="handleSeriesChange">
          ...
          <el-form-item>
            ...
            <el-date-picker type="date" placeholder="选择注册日期" format="yyyy-MM-dd" value-format="yyyy-MM-dd" :picker-options="pickerOptions"
              v-model="formModel.onTime"></el-date-picker>
          </el-form-item>
          <el-form-item label="行驶证">
            <div class="image-content">
              ...
              <div>
                <el-button type="primary" :disabled="!formModel.carLicense.positiveImage&&!formModel.carLicense.backgroundImage"  v-show="!!formModel.id" size="mini" @click="reject">驳回</el-button>
              </div>
            </div>
          </el-form-item>
          <el-form-item label="营运">
            <el-switch v-model="formModel.isCV" active-value="1" inactive-value="0" inactive-color="#d9d9d9" active-color="#87d068">
            </el-switch>
          </el-form-item>
        ...
        <el-collapse-item title="更多信息" name="2">
          <el-form-item label="车辆识别代号" prop="vin">
            <div slot="label">
              ...
              <el-popover ref="vinPop" placement="bottom-start" width="300" trigger="hover" content="车辆识别代号，即车架号，具有对车辆的唯一识别性，因此可称为“汽车身份证”。您可在车辆行驶证上查询到此信息，也可打开发动机盖，在挡板上可看到此码。">
              </el-popover>
            </div>
          ...
          <el-form-item label="生产日期">
            <el-date-picker type="date" placeholder="选择生产日期" format="yyyy-MM-dd" value-format="yyyy-MM-dd" :picker-options="pickerOptions"
              v-model="formModel.productionTime" style="width: 100%;"></el-date-picker>
          </el-form-item>
        </el-collapse-item>
        <el-collapse-item title="销售信息" name="3">
          ...
          <el-form-item label="购买日期" prop="purchaseTime">
            <el-date-picker type="date" placeholder="请选择购买日期" format="yyyy-MM-dd" value-format="yyyy-MM-dd" :picker-options="pickerOptions"
              v-model="formModel.carSalesData.purchaseTime" style="width: 100%;"></el-date-picker>
          </el-form-item>
          ...
          <el-form-item label="销售公司电话" prop="salesCompanyPhone">
            <el-input v-model="formModel.carSalesData.salesCompanyPhone" type="phone" maxlength="12" placeholder="请输入销售公司电话"></el-input>
          </el-form-item>
          ...
          <el-form-item label="销售员电话" prop="salesStaffPhone">
            <el-input v-model="formModel.carSalesData.salesStaffPhone" type="phone" maxlength="13" placeholder="请输入销售员电话"></el-input>
          </el-form-item>
        </el-collapse-item>
        <el-collapse-item title="质保信息" name="4">
          <el-form-item label="质保起始日期" prop="purchaseTime">
            <el-date-picker type="date" placeholder="请选择保起始日期" format="yyyy-MM-dd" value-format="yyyy-MM-dd" v-model="qualityAssuranceDate"
          ...
          <el-form-item label="质保截止日期" prop="purchaseTime">
            <el-date-picker type="date" placeholder="请选择质保截止日期" format="yyyy-MM-dd" value-format="yyyy-MM-dd" v-model="qualityAssuranceEndDate"
              style="width: 100%;" disabled></el-date-picker>
          </el-form-item>
        </el-collapse-item>
        <el-collapse-item title="保养信息" name="5">
          ...
          <el-form-item label="保养日期">
            <el-date-picker type="date" placeholder="选择保养日期" format="yyyy-MM-dd" value-format="yyyy-MM-dd" :picker-options="pickerOptions"
              v-model="formModel.carMaintain.happenDate" style="width: 100%;"></el-date-picker>
          </el-form-item>
        ...
        <el-collapse-item title="保险信息" name="6">
          <el-form-item label="投保公司">
            <el-select v-model="formModel.carInsurance.insuranceCompany" placeholder="请选择投保公司" style="width: 100%;" @change="handleInsuranceChange">
          ...
          <el-form-item label="保单生效日期">
            <el-date-picker type="date" placeholder="选择保单生效日期" format="yyyy-MM-dd" value-format="yyyy-MM-dd" v-model="formModel.carInsurance.policyEffectiveDate"
              style="width: 100%;"></el-date-picker>
          </el-form-item>
          <el-form-item label="保单失效日期" prop="policyExpiryDate">
            <el-date-picker type="date" placeholder="选择保单失效日期" format="yyyy-MM-dd" value-format="yyyy-MM-dd" v-model="formModel.carInsurance.policyExpiryDate"
              style="width: 100%;"></el-date-picker>
          </el-form-item>
          ...
          <el-form-item label="理赔员电话" prop="claimMemberPhone">
            <el-input v-model="formModel.carInsurance.claimMemberPhone" type="phone" maxlength="13" placeholder="请输入理赔员电话"></el-input>
          </el-form-item>
        ...
        <el-collapse-item title="终端信息" name="7">
          <div>
            <biz-header :operations="ruleTableOperations" @operate="operateHandler">
            </biz-header>
            <el-table :data="formModel.terminals" style="width: 100%" class="cp-table" size="small">
              ...
              <el-form ref="ruleForm" size="small" label-width="110px" :model="ruleModel" :rules="ruleRules">
                <el-form-item label="设备编号" prop="number">
                  <el-autocomplete :value="ruleModel.number" :fetch-suggestions="handleRemote" placeholder="请输入设备编号"
                    :trigger-on-focus="false" @select="handleNumberChange" @input="handleNumberInput" value-key="number" style="width: 100%;"></el-autocomplete>
                </el-form-item>
        ...
        <el-collapse-item title="所属店铺" name="8">
  ...
  methods: {
    ...
    handleDeleteClick(row) {
      this.$confirm('是否确认删除?', '提示', {
        ...
        this.loading = true;
        http
          .delete('/admin/car/relateShop.jhtml', { shopId: row.id, id: this.itemId.id })
          .then(data => {
          ...
          if (this.formModel.id) {
            service.update(
              ...
              data => {
                ...
                this.$emit('confirmAddCar', this.formModel);
              },
              // result_code 不是100的处理
              ErrorData => {
