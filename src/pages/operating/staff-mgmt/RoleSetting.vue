<template>
  <biz-grid class="staff-mgmt-role-setting">
    <biz-save-button slot="top" :operations="operations" @operate="operate"></biz-save-button>
    <el-form :rules="rules" ref="authorForm" :model="form" v-loading="loading" label-position="right">
...
export default {
  ...
  data() {
    return {
      ...
      typeList: [],
      authorityList: [],
      operations: [{ label: '保存', name: 'save', type: 'primary', auth: ['admin:role.edit'] }],
      loading: false,
