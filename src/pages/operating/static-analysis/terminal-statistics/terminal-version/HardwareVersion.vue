...
export default {
  ...
  methods: {
    ...
    conditionChange(val) {
      console.log(val, this.checkedChannel);
      if (val.length === 2) {
    ...
    async exportExcle() {
      ...
      try {
        let response = await axios.post(urls.terminalMgmt.hardExport, params, { responseType: 'blob' });
    ...
    getTerminalTypeList() {
      ...
      http
        .get(urls.terminalMgmt.hardTypeList, param)
        // .get('http://192.168.50.120:3000/mock/11/admin/ecommerce/kpi/condition/terminal/hardVer.jhtml', param)
        .then(data => {
          console.log('硬件', data);
          this.loading = false;
    ...
    getGraphData() {
      ...
      http
        .post(urls.terminalMgmt.hardGraphData, param)
        // .post('http://192.168.50.120:3000/mock/11/admin/ecommerce/kpi/graph/terminal/hardVer.jhtml', param)
        .then(data => {
    ...
    getTabelData() {
      ...
      let param = this.getParams();
      http
        .post(urls.terminalMgmt.hardTabelData, param)
        // .post('http://192.168.50.120:3000/mock/11/admin/ecommerce/kpi/table/terminal/hardVer.jhtml', param)
        .then(data => {
