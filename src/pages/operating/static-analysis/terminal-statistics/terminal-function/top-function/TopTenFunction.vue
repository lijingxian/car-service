...
export default {
  ...
  methods: {
    ...
    async exportExcle() {
      ...
      try {
        let response = await axios.post(urls.terminalMgmt.topExport, params, { responseType: 'blob' });
    ...
    getTerminalTypeList() {
      ...
      http
        .get(urls.terminalMgmt.topCondition, param)
        .then(data => {
          this.loading = false;
    ...
    getGraphData() {
      ...
      http
        .post(urls.terminalMgmt.topGraph, param)
        .then(data => {
    ...
    getTabelData() {
      ...
      let param = this.getParams();
      http
        .post(urls.terminalMgmt.topTabel, param)
        .then(data => {
          this.loading = false;
