<template>
  <div class="time-distribution">
     <biz-chart :chartData="chartData" :loading="loading" :showViewType="false" :showPagination="false" @refreshHandle="refreshHandle" @exportExcle="exportExcle">
...
export default {
  ...
  methods: {
    ...
    async exportExcle() {
      ...
      try {
        let response = await axios.post(urls.terminalMgmt.timeExport, params, { responseType: 'blob' });
    ...
    getTerminalTypeList() {
      ...
      http
        .get(urls.terminalMgmt.timeCondition, param)
        .then(data => {
          this.loading = false;
    ...
    getGraphData() {
      ...
      this.chartData = {};
      http
        .post(urls.terminalMgmt.timeGraph, param)
        .then(data => {
          this.loading = false;
    ...
    getTabelData() {
      ...
      let param = this.getParams();
      http
        .post(urls.terminalMgmt.timeTabel, param)
        .then(data => {
          this.loading = false;
