<template>
  <div class="last-ten-function">
     <biz-chart :chartData="chartData" :loading="loading" :showViewType="false" :axisLabelRotate='45' :showPagination="false" @refreshHandle="refreshHandle" @exportExcle="exportExcle">
...
export default {
  ...
  methods: {
    ...
    async exportExcle() {
      ...
      try {
        let response = await axios.post(urls.terminalMgmt.lastExport, params, { responseType: 'blob' });
    ...
    getTerminalTypeList() {
      ...
      http
        .get(urls.terminalMgmt.lastCondition, param)
        .then(data => {
          console.log('趋势', data);
          this.loading = false;
    ...
    getGraphData() {
      ...
      http
        .post(urls.terminalMgmt.lastGraph, param)
        .then(data => {
          this.loading = false;
    ...
    getTabelData() {
      ...
      let param = this.getParams();
      http
        .post(urls.terminalMgmt.lastTabel, param)
        .then(data => {
          this.loading = false;
