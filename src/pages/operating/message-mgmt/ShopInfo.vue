<template>
  <biz-grid class="message-mgmt-shop-info">
    <el-form :rules="rules" ref="form" :model="form" label-width="120px" size="small" v-loading="loading">
      ...
      <el-row class="el-row" v-show="showSetting">
        <el-col :span="8">
          <div class="grid-content bg-purple">资源</div>
        </el-col>
        <el-col :span="8">
          <div class="grid-content bg-purple-light">父→子</div>
        </el-col>
        <el-col :span="8">
          <div class="grid-content bg-purple">子→父</div>
        </el-col>
      </el-row>
      <el-row class="el-row" v-for="configData in form.configList" :key="configData.type" v-show="showSetting">
        <el-col :span="8">
          <div class="grid-content bg-purple">
            {{configModel[configData.type]}}
          </div>
        </el-col>
        <el-col :span="8">
          <div class="grid-content bg-purple-light">
            <el-select v-model="configData.toSon">
              <el-option label="无" value="0"></el-option>
              <el-option label="分享" value="1"></el-option>
              <!-- <el-option label="分享审核" value="2"></el-option> -->
            </el-select>
          </div>
        </el-col>
        <el-col :span="8">
          <div class="grid-content bg-purple">
            <el-select v-model="configData.toFather">
              <el-option label="无" value="0"></el-option>
              <el-option label="分享" value="1"></el-option>
              <el-option label="分享审核" value="2" v-show="configData.type==='2'||configData.type==='3'"></el-option>
            </el-select>
          </div>
        </el-col>
      </el-row>
