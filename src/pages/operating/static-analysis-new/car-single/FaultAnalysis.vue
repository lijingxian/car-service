    ...
    <div class="chart-area">
      <div class="graph">
        <div class="filterSeach">
          <div class="filter-area">
            <el-radio-group v-model="indicatorValue" size="mini">
              <el-radio-button label="singleFaultReason">故障</el-radio-button>
            </el-radio-group>
          </div>
        ...
        <biz-list ref="list" :height="height" :tableData="tableData" style="width: 100%" v-if="!isShow">
          <el-table-column prop="plateNumber" label="故障车辆"></el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      indicatorValue: 'singleFaultReason',
      viewType: 'month',
      pagination: {
        pageSize: 20,
        currentPage: 1,
  ...
  methods: {
    ...
    async exportExcle() {
      ...
      try {
        let response = await axios.post('/admin/ecommerce/kpi/car/export/carFaults.jhtml', params, { responseType: 'blob' });
