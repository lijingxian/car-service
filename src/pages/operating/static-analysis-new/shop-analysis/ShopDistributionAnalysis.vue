<template>
  <div class="shop-distribution-analysis">
    <div slot="top">
    ...
    <div class="chart-area">
      <div class="graph">
        ...
        <div class="content" style="width:40%;float:right;line-height:40px;font-size: 13px;padding:100px;height:70vh;overflow:auto" v-if="isShow">
        ...
        <biz-list ref="list" :height="height" :tableData="tableData" style="width: 100%" v-if="!isShow">
          ...
          <el-table-column prop="score" label="店铺评分" v-if="this.filters[0].value==='0'"></el-table-column>
          <el-table-column prop="staffCount" label="员工数量" v-if="this.filters[0].value==='1'"></el-table-column>
          <el-table-column prop="memberCount" label="会员数量" v-if="this.filters[0].value==='2'"></el-table-column>
          <el-table-column prop="carCount" label="车辆数" v-if="this.filters[0].value==='3'"></el-table-column>
          <el-table-column prop="satisfaction" label="用户满意度" v-if="this.filters[0].value==='4'"></el-table-column>
        </biz-list>
  ...
  methods: {
    ...
    getShopList() {
      if (this.getUser().roleLevel === 'shop') {
        ...
        // this.checkedShopByShop = this.params.checkedShopByShop || [this.shopListByShop[0].id] || [];
      } else {
        let param = {
    ...
    getGraphData() {
      ...
      if (this.filters[0].value === '0') {
        urls = '/admin/ecommerce/kpi/graph/store/storeGrade.jhtml';
      } else if (this.filters[0].value === '1') {
        urls = '/admin/ecommerce/kpi/graph/store/storeStaffCount.jhtml';
      } else if (this.filters[0].value === '2') {
        urls = '/admin/ecommerce/kpi/graph/store/storeMemberCount.jhtml';
      } else if (this.filters[0].value === '3') {
        urls = '/admin/ecommerce/kpi/graph/store/storeCarCount.jhtml';
      } else if (this.filters[0].value === '4') {
        urls = '/admin/ecommerce/kpi/graph/store/storeSatisfaction.jhtml';
      }
      http
    ...
    getTable() {
      ...
      let urls = '';
      if (this.filters[0].value === '0') {
        urls = '/admin/ecommerce/kpi/table/store/storeGrade.jhtml';
      } else if (this.filters[0].value === '1') {
        urls = '/admin/ecommerce/kpi/table/store/storeStaffCount.jhtml';
      } else if (this.filters[0].value === '2') {
        urls = '/admin/ecommerce/kpi/table/store/storeMemberCountList.jhtml';
      } else if (this.filters[0].value === '3') {
        urls = '/admin/ecommerce/kpi/table/store/storeCarCountList.jhtml';
      } else if (this.filters[0].value === '4') {
        urls = '/admin/ecommerce/kpi/table/store/storeSatisfaction.jhtml';
      }
      http
        .get(urls + '?' + paramsArr.join('&'))
        .then(data => {
    ...
    exportStart() {
      ...
      let urls = '';
      if (this.filters[0].value === '0') {
        urls = '/admin/ecommerce/kpi/export/store/exportStoreGradeStart.jhtml';
      } else if (this.filters[0].value === '1') {
        urls = '/admin/ecommerce/kpi/export/store/exportStoreStaffCountStart.jhtml';
      } else if (this.filters[0].value === '2') {
        urls = '/admin/ecommerce/kpi/export/store/exportStoreMemberCountListStart.jhtml';
      } else if (this.filters[0].value === '3') {
        urls = '/admin/ecommerce/kpi/export/store/exportStoreCarCountListStart.jhtml';
      } else if (this.filters[0].value === '4') {
        urls = '/admin/ecommerce/kpi/export/store/exportStoreSatisfactionStart.jhtml';
      }
      http
        .post(urls, params)
        .then(data => {
