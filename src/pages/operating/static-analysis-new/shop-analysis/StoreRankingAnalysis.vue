<template>
  <div class="store-ranking-analysis">
    <div slot="top">
    ...
    <div class="chart-area">
      <div class="graph">
        ...
        <biz-list ref="list" :height="height" :tableData="tableData" style="width: 100%" v-if="!isShow">
          ...
          <el-table-column prop="orderAmount" label="营业额" v-if="this.filters[0].value==='0'"></el-table-column>
          <el-table-column prop="orderCount" label="订单量" v-if="this.filters[0].value==='1'"></el-table-column>
          <el-table-column prop="memberCount" label="会员数" v-if="this.filters[0].value==='2'"></el-table-column>
  ...
  methods: {
    ...
    getGraphData() {
      ...
      if (this.filters[0].value === '0') {
        urls = '/admin/ecommerce/kpi/graph/store/storesOrderAmountRanking.jhtml';
      } else if (this.filters[0].value === '1') {
        urls = '/admin/ecommerce/kpi/graph/store/storesOrderCountRanking.jhtml';
      } else if (this.filters[0].value === '2') {
        urls = '/admin/ecommerce/kpi/graph/store/storesNewMemberRanking.jhtml';
      } else if (this.filters[0].value === '3') {
        urls = '/admin/ecommerce/kpi/graph/store/storesNewCarRanking.jhtml';
      }
      http
    ...
    getTable() {
      ...
      let urls = '';
      if (this.filters[0].value === '0') {
        urls = '/admin/ecommerce/kpi/table/stores/storeRankingOrderAmountList.jhtml';
      } else if (this.filters[0].value === '1') {
        urls = '/admin/ecommerce/kpi/table/stores/storeRankingOrderCountList.jhtml';
      } else if (this.filters[0].value === '2') {
        urls = '/admin/ecommerce/kpi/table/stores/storeRankingMemberCountList.jhtml';
      } else if (this.filters[0].value === '3') {
        urls = '/admin/ecommerce/kpi/table/stores/storeRankingCarCountList.jhtml';
      }
      http
        .get(urls + '?' + paramsArr.join('&'))
        .then(data => {
    ...
    exportStart() {
      ...
      let urls = '';
      if (this.filters[0].value === '0') {
        urls = '/admin/ecommerce/kpi/export/stores/exportStoreRankingOrderAmountListStart.jhtml';
      } else if (this.filters[0].value === '1') {
        urls = '/admin/ecommerce/kpi/export/stores/exportStoreRankingOrderCountListStart.jhtml';
      } else if (this.filters[0].value === '2') {
        urls = '/admin/ecommerce/kpi/export/stores/exportStoreRankingMemberCountListStart.jhtml';
      } else if (this.filters[0].value === '3') {
        urls = '/admin/ecommerce/kpi/export/stores/exportStoreRankingCarCountListStart.jhtml';
      }
      http
        .post(urls, params)
        .then(data => {
