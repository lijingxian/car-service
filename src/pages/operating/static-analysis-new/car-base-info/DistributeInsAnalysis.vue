  ...
  <div class="disins-analysis">
    ...
    <div class="chart-area" v-loading="loading">
      <div class="graph">
        <div class="filterSeach">
          <div class="filter-area">
            <el-radio-group @change="indicatorChanged" v-model="indicatorValue" size="mini">
              <el-radio-button label="carBrandIns">品牌车系</el-radio-button>
              <el-radio-button label="carPriceIns">价格</el-radio-button>
              <el-radio-button label="carAgeIns">车龄</el-radio-button>
              <el-radio-button label="carAddressIns">位置</el-radio-button>
            </el-radio-group>
          </div>
        ...
        <div class="content" style="width:40%;float:right;line-height:40px;font-size: 13px;padding:100px;height:600px;overflow:auto" v-show="radioValue==='0'&&indicatorValue!=='carAddressIns'">
        ...
        <biz-chart :chartData="chartDataOfBrandSeries" :loading="loading" :showSearch="false" v-if="radioValue==='0'&&indicatorValue==='carBrandIns'"></biz-chart>
        <biz-chart :chartData="chartDataOfPrice" :loading="loading" :showSearch="false" v-if="radioValue==='0'&&indicatorValue==='carPriceIns'"></biz-chart>
        <biz-chart :chartData="chartDataOfAge" :loading="loading" :showSearch="false" v-if="radioValue==='0'&&indicatorValue==='carAgeIns'"></biz-chart>
        <div style="width: 600px;margin:0 auto">
          <biz-chart
            ...
            v-if="radioValue==='0'&&indicatorValue==='carAddressIns'"
          ></biz-chart>
        </div>
...
export default {
  ...
  methods: {
    ...
    indicatorChanged() {
      if (this.indicatorValue === 'carBrandIns') {
        this.getGraphBrandSeriesData();
      } else if (this.indicatorValue === 'carPriceIns') {
        this.getGraphPriceData();
      } else if (this.indicatorValue === 'carAgeIns') {
    ...
    exportStart() {
      ...
      http
        .post('/admin/ecommerce/kpi/car/export/cars/exportStart.jhtml', params)
        .then(data => {
    ...
    async exportExcle() {
      try {
        let response = await axios.get('/admin/ecommerce/kpi/car/export/cars/exportResult.jhtml?taskId=' + this.taskId, { responseType: 'blob' });
