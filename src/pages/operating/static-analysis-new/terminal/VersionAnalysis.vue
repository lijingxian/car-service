  ...
  <div class="terminal-distribute-analysis">
    ...
    <div class="chart-area">
      <div class="graph">
        <div class="filterSeach">
          <div class="filter-area">
            <el-radio-group @change="indicatorChanged" v-model="indicatorValue" size="mini">
              <el-radio-button label="0">硬件版本</el-radio-button>
              <el-radio-button label="1">软件版本</el-radio-button>
            </el-radio-group>
          </div>
        ...
        <biz-chart :chartData="chartDataOfHard" :loading="loading" :showSearch="false" v-if="radioValue==='0'&&indicatorValue==='0'"></biz-chart>
        <biz-chart :chartData="chartDataOfSoft" :loading="loading" :showSearch="false" v-if="radioValue==='0'&&indicatorValue==='1'"></biz-chart>
  ...
  methods: {
    ...
    getGraphData() {
      ...
      http
        ...
        .then(data => {
          this.chartDataOfHard = this.dataFormat(data);
        })
        .catch(errData => {
          this.loading = false;
    ...
    getTable() {
      ...
      http
        .post('/admin/ecommerce/kpi/table/terminal/hardVer.jhtml', params)
        .then(data => {
    ...
    getGraphDataSoft() {
      ...
      http
        .post('/admin/ecommerce/kpi/graph/terminal/softVer.jhtml', params)
        .then(data => {
          this.chartDataOfSoft = this.dataFormat(data);
        })
        .catch(errData => {
          this.loading = false;
          if (errData.errorMessage) this.$message.warning(errData.errorMessage);
    ...
    getTableSoft() {
      ...
      http
        .post('/admin/ecommerce/kpi/table/terminal/softVer.jhtml', params)
        .then(data => {
          this.tableData = data.dataList;
          this.pagination.total = Number(data.total);
        })
    ...
    exportStart() {
      ...
      http
        .post(this.indicatorValue === '0' ? '/admin/ecommerce/kpi/export/terminal/hardVer/exportStart.jhtml' : '/admin/ecommerce/kpi/export/terminal/softVer/exportStart.jhtml', params)
        .then(data => {
    ...
    async exportExcle() {
      try {
        let response = await axios.get(this.indicatorValue === '0' ? '/admin/ecommerce/kpi/export/terminal/hardVer/exportResult.jhtml?taskId=' + this.taskId : '/admin/ecommerce/kpi/export/terminal/softVer/exportResult.jhtml?taskId=' + this.taskId, { responseType: 'blob' });
