<template>
  <biz-grid class="vehicle-mgmt-all-vehicle__vehicle-share">
    <div>
      <biz-header slot="top" v-if="isEdit" :operations="ruleTableOperations" @operate="operateHandler">
      </biz-header>
      <el-table :data="tableData" style="width: 100%" height="350" @selection-change="selectionChangeHandler">
      ...
      <el-card class="box-card" v-show="showRule">
