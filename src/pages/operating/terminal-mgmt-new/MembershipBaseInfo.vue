  ...
  <biz-grid class="terminal-mgmt-membership-base-info" v-loading="loading">
    ...
    >
      ...
      <el-form-item label="手机号" prop="mobile">
        <el-input v-model="formModel.mobile" type="phone" maxlength="11" placeholder="请输入手机号"></el-input>
      </el-form-item>
      ...
      <el-form-item label="邮编" prop="zipCode">
        <el-input v-model="formModel.zipCode" type="number" placeholder="请输入邮编"></el-input>
      </el-form-item>
    ...
    return {
      ...
      rules: {
        userName: [
          ...
          { min: 2, max: 15, trigger: 'blur', message: '用户名长度在2-15个字符之间' }
        ],
        mobile: [
