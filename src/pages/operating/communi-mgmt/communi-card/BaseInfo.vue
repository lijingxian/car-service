<template>
  <biz-grid class="communi-mgmt-communi-card-base-info">
    ...
    >
      ...
      <el-form-item label="ICCID" prop="iccid">
        <el-input v-model="form.iccid" placeholder="请输入ICCID号"></el-input>
      </el-form-item>
      <el-form-item label="卡类型" prop="type">
        <el-select v-model="form.type" placeholder="请选择卡类别" @change="typeChange">
      ...
      <el-form-item label="所有者" prop="ownerName">
        <el-input v-model="form.ownerName" placeholder="请选择所有者">
          <el-button slot="append" @click="selectOwner">选择</el-button>
        </el-input>
      </el-form-item>
      ...
      <el-form-item label="终端分类" prop="terminalTypeName">
      ...
      <el-form-item label="套餐" prop="rechargePackageName">
        <el-input v-model="form.rechargePackageName" placeholder="请输入套餐名称" disabled></el-input>
      </el-form-item>
      ...
      <el-form-item label="创建日期" prop="createdTime">
        <el-date-picker type="date" v-model="form.createdTime" value-format="yyyy-MM-dd HH:mm:ss" format="yyyy-MM-dd HH:mm:ss" disabled></el-date-picker>
      </el-form-item>
      <el-form-item label="激活日期" prop="createdTime">
        <el-date-picker type="date" v-model="form.activatedTime" value-format="yyyy-MM-dd HH:mm:ss" format="yyyy-MM-dd HH:mm:ss" disabled></el-date-picker>
      </el-form-item>
      <el-form-item label="到期日期" prop="createdTime">
        <el-date-picker type="date" v-model="form.expiredTime" value-format="yyyy-MM-dd HH:mm:ss" format="yyyy-MM-dd HH:mm:ss" disabled></el-date-picker>
      </el-form-item>
    ...
    <biz-dialog-selector
      ...
      :appendToBody="true"
      :keyField="'id'"
      :selectionKeys="Array(form.ownerId)"
...
export default {
  ...
  data () {
    return {
      ...
      dialogFilters: [
        { type: 'input', value: '', placeholder: '请输入用户名、昵称、手机号' }
      ],
      // Dialog End
      // 是否查找父级运营商
      queryParent: false,
      ...
      rules: {
        ...
        iccid: [
          ...
          { pattern: /^[0-9a-zA-Z]*$/g, message: '请输入字母或数字', trigger: 'blur' }
        ],
        telecomOperatorId: [
  ...
  methods: {
    ...
    create() {
      this.loading = true;
      let params = Object.assign({}, this.form, this.telecomOperator, { companyId: this.companyInfo.id, companyName: this.companyInfo.name });
    ...
    update() {
      this.loading = true;
      let params = Object.assign({}, this.form, this.telecomOperator, { companyId: this.companyInfo.id, companyName: this.companyInfo.name }, this.itemId);
...
.communi-mgmt-communi-card-base-info {
  .biz-save-button {
