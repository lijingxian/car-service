      ...
      <el-form ref="logisticsForm" size="small" label-width="110px" :model="form" :rules="rules" :inline-message="true">
        <el-table :data="form.orderItems" style="width: 100%" size="small">
          ...
          <el-table-column label="本次发货数量" v-if="!isShipped">
            <div slot-scope="scope">
              <div class="biz-customcol">
                <el-input-number size="mini" :min="0" v-model="scope.row.unShippedQuantity" :disabled="isShipped||scope.row.isDisabled"></el-input-number>
              </div>
            </div>
          </el-table-column>
        </el-table>
        ...
        <div class="close-button" style="float:right">
          <el-button @click="showLogistics=false" size="mini">取消</el-button>
    ...
    init() {
      ...
      service.viewOrder(
        ...
        data => {
          ...
          this.form.orderItems.forEach((element, index) => {
            if (element.unShippedQuantity === '0') {
