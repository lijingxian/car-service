<template>
  <div class="invoice-info-hy">
    ...
    <el-card v-for="(invoice) in invoiceList" :key="invoice.id">
      <div>
        <div class="radio-i" @click="selectItem(invoice)">
          <el-radio v-model="invoice.checked" label="1" size="mini"><span style="color:#ffffff">.</span>
          </el-radio>
          <div>
            <div class="default">
              <span>发票抬头：</span>
