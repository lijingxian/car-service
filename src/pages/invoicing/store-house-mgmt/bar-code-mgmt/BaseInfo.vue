<template>
  <biz-grid class="bar-basic-info">
    ...
    <el-form ref="form" :model="form" label-width="120px" size="small" v-loading="loading" :rules="rules" :disabled="!isEdit" :inline-message="true">
      ...
      <el-form-item label="条码规则" prop="codeRule" class="isRequired">
        <el-popover placement="right-start" trigger="hover" content="包含前缀、中码、后码" class="button-tshi">
          <el-button slot="reference" size="mini" type="text" style="border-radius: 10px">
            <i class="iconfont el-icon-question"></i>
          </el-button>
        </el-popover>
      </el-form-item>
      <el-form-item label="前缀" prop="prefix">
        <el-input v-model="form.prefix" placeholder="请输入前缀字符(至多4位)" maxlength="4" @change="clear"></el-input>
      </el-form-item>
      <el-form-item label="中码" prop="middleCodeType">
        <el-select v-model="form.middleCodeType" placeholder="请选择" @change="clear">
          <el-option label="无" value=""></el-option>
          <el-option label="商品编号" value="0"></el-option>
          <!-- <el-option label="车辆识别代码(VIN码)" value="1"></el-option> -->
        </el-select>
      </el-form-item>
      <el-form-item label="后缀" prop="postfixType">
        <el-select v-model="form.postfixType" placeholder="请选择" @change="clear">
          <el-option label="无" value=""></el-option>
          <el-option label="4位随机数" value="0"></el-option>
          <el-option label="5位随机数" value="1"></el-option>
          <el-option label="6位随机数" value="2"></el-option>
        </el-select>
      </el-form-item>
      ...
      operations: [
        {
          ...
          name: 'save',
          type: 'primary',
          auth: ['admin:storage.barCode.edit']
        }
      ],
      selectionKeys: [],
      categoryOptions: [],
