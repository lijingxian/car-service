    ...
    <el-form ref="form" label-width="120px" size="small" v-loading="loading" :model="formData" :inline-message="true">
      ...
      <div v-if="formData.way==='1'">
        ...
        <div v-if="this.tableData.length<6">
          ...
          <div class="addButton" style="cursor: pointer;width: 20px;height: 20px;border-radius: 50%;background: #333;color: #fff;font-size: 15px;line-height: 18px;text-align: center;z-index: 2;">
