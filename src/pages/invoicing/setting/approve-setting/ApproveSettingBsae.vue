<template>
  <biz-grid class="approve-s-bsae">
    <div slot="top" class="popup">
      <biz-save-button slot="top" :operations="operations" @operate="operate"></biz-save-button>
    </div>
    <el-form ref="form" label-width="120px" size="small" v-loading="loading" :model="formData" :inline-message="true">
      <el-form-item label="审批审核">
        <el-switch v-model="formData.enabled" active-value="1" inactive-value="0" active-color="#ff7300" inactive-color="#d9d9d9"></el-switch>
      </el-form-item>
      <el-form-item label="审批流程设置"></el-form-item>
