<template>
  <biz-grid class="invoice-info-p-order">
...
export default {
  ...
  data() {
    return {
      invoiceList: [],
      showForm: false,
      operations: [{ label: '添加', name: 'add', type: 'primary' }],
      formOperations: [{ label: '保存', name: 'save', type: 'primary' }, { label: '取消', name: 'cancel', type: 'primary', auth: ['admin:purchaseOrder.edit'] }],
      rules: {
