<template>
  <biz-grid class="category-mgmt__category-setting">
    ...
    <el-form ref="form" size="small" label-width="110px" :model="productCategory" :rules="rules" :disabled="!isEdit" :inline-message="true">
      ...
      <el-form-item label="logo：" prop="logo">
        <BizAvatarUploaderNew v-model="productCategory.logo" @uploadSuccess="uploadSuccess"></BizAvatarUploaderNew>
      </el-form-item>
      <el-form-item label="品牌:" prop="shopBrands">
  ...
  methods: {
    ...
    queryWidthId(id) {
      ...
      service.getProductCategory(
        ...
        data => {
          ...
          let tmpproductCategory = Object.assign(this.getDefaultProductCategory(), data.productCategory);
          ...
          tmpproductCategory.logo = data.productCategory.logo === '' ? this.defaultImg : data.productCategory.logo;

          this.productCategory = tmpproductCategory;
          // if (!this.productCategory.shopBrandIds) {
          //   this.productCategory.shopBrandIds = [];
          // }
          console.log(this.productCategory.shopBrandIds);
          this.checkAll =
            this.productCategory.shopBrandIds && this.productCategory.shopBrandIds.length > 0 && this.productCategory.shopBrandIds.length === this.brands.length;
    ...
    getSaveParams() {
      return {
        ...
        logo: this.productCategory.logo ? this.productCategory.logo : this.defaultImg,
