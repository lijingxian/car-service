<template>
  <biz-grid class="category-mgmt__specification-setting">
    ...
    <el-dialog :visible.sync="showSpecificationDataEditor" center append-to-body width="500px">
      <el-form ref="specificationDataForm" size="small" label-width="110px" :model="specificationData" :rules="rules" :inline-message="true">
        ...
        <el-form-item label="规格值: " prop="valueList">
          <el-tag
            v-for="tag in specificationData.valueList"
            :key="tag.id"
            size="small"
            closable
      ...
      <el-form ref="specificationValueForm" size="small" label-width="110px" :model="specificationValueData" :rules="rules" v-show="showSpecificationValueEditor" :inline-message="true">
