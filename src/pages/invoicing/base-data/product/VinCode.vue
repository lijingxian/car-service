    ...
    <el-dialog class="box-card" :visible.sync="showForm" center append-to-body width="500px">
      <el-form ref="form" size="small" label-width="110px" :model="formModel" :rules="rules" :inline-message="true">
        <el-form-item label="车辆识别码" prop="number">
          <el-input v-model="formModel.number" placeholder="请输入车辆识别码"></el-input>
        </el-form-item>
      </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      tabName: 'first',
      operations: [
        { label: '新增', name: 'add', type: 'primary', auth: ['admin:PurchaseSaleStorage.product.edit'] },
        { label: '删除', name: 'del', disabled: true, auth: ['admin:PurchaseSaleStorage.product.edit'] },
