<template>
  <biz-grid class="propetry-base-info">
    ...
    <el-form ref="form" :model="form" label-width="106px" size="small" :disabled="!isEdit" :inline-message="true">
      <el-form-item label="商品介绍"></el-form-item>
      <div class="h-editor">
        <biz-editor height="400px" width="618px" v-model="form.introduction"></biz-editor>
      </div>
      <el-form-item label="购买须知"></el-form-item>
      <div class="h-editor">
        <biz-editor height="400px" width="618px" v-model="form.notice"></biz-editor>
      </div>
      <el-form-item label="产品售后"></el-form-item>
      <div class="h-editor">
        <biz-editor height="400px" width="618px" v-model="form.afterSale"></biz-editor>
      </div>
      <el-form-item label="语音播报介绍" label-width="135px"></el-form-item>
      <div class="y-editor">
        <el-input v-model="form.memo" type="textarea" maxlength="200" :autosize="{ minRows: 5, maxRows: 8 }" width="430px"></el-input>
      </div>
    </el-form>
  </biz-grid>
</template>
