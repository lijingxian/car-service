<template>
  <div class="commodity-mgmt-parameter">
    ...
    <el-form ref="form" size="small" label-width="120px" :disabled="!isEdit" :inline-message="true">
...
export default {
  ...
  methods: {
    ...
    editCategory() {
      this.$router.push({ path: '/invoicing/base-data/category', query: { id: this.categoryId, from: 'parameter' } });
    },
    query() {
      let params = {
        id: this.itemId
