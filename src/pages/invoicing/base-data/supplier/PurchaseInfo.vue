<template>
  <biz-grid class="purchase-info" v-loading="loading">
    <div slot="top">
      <biz-header
        @operate="operate"
        :filters="filters"
  ...
  methods: {
    ...
    getList() {
      let params = {
        ...
        supplierIds: [this.itemId.id],
        beginTime: this.filters[1].value[0] ? this.filters[0].value[0] + ' ' + '00:00:00' : '',
        endTime: this.filters[1].value[1] ? this.filters[0].value[1] + ' ' + '23:59:59' : ''
      };
      this.loading = true;
      http
        .post('/admin/purchaseOrder/purchaser/orders.jhtml', params)
        .then(data => {
