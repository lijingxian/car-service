      ...
      <el-table-column prop="date" label="操作" width="150">
        <div slot-scope="scope">
          <div class="biz-customcol">
            <el-button type="text" size="mini" v-if="scope.row.opeateState === '0'" @click="addHandeler(scope.row)">添加为管理员</el-button>
            <el-button type="text" size="mini" v-if="scope.row.opeateState === '1'" @click="deleteHandeler(scope.row.masterId)">移除</el-button>
          </div>
        </div>
      </el-table-column>
    </biz-list>
