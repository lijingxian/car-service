  ...
  <biz-grid class="import-brand-series" v-loading="loading">
    ...
    <el-form label-width="80px" size="small">
      ...
      <el-form-item label="系列：">
        <biz-list ref="table" :height="heightList" :tableData="seriesDataList" @handleSelectionChange="handleSelectionChange">
...
export default {
  ...
  components: { BizGrid, BizSaveButton, BizList, ImportFile },
  created() {
    this.getBrandName();
  },
  computed: {},
