<template>
  <biz-grid class="lead-base-info-s-product" v-loading="loading">
    <biz-save-button slot="top" :operations="operations" @operate="operate"></biz-save-button>
    <el-form ref="form" :rules="rules" size="small" :inline-message="true">
      <div class="radio">
      ...
      <div class="importFile">
        <el-form-item v-show="showType === '文件导入'">
          <import-file
            ...
            :stepkey="stepkey"
            :action="'/admin/invoicingProduct/importSupplierProduct.jhtml'"
            :name="'uFile'"
            ref="importFile"
          ...
          <template>
            <div class="category-select">
              <el-form label-width="120px" size="small" :inline-message="true">
                <el-form-item label="分类：" prop="topProductCategoryId" class="isRequired">
...
export default {
  ...
  methods: {
    ...
    downloadTemplate() {
      window.open('/upload/mode/V服爱车_供应商_商品导入模板.xlsx');
    },
