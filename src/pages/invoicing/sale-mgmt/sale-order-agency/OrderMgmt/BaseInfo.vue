  ...
  <biz-grid class="order-base-info">
    ...
    <el-form ref="form" :model="form" label-width="120px" size="small" v-loading="loading" :disabled="!isEdit" :inline-message="true">
      ...
      <el-form-item label="订金" prop="amountPrepay" v-if="form.amountPrepay">
        <el-input v-model="form.amountPrepay" :disabled="itemId!==''&&(form.type==='交易完成'||form.type==='订单关闭'||form.type==='已评价')"></el-input>
      </el-form-item>
      <el-form-item label="尾款" prop="amountFinalpay" v-if="form.amountFinalpay">
        <el-input v-model="form.amountFinalpay" :disabled="itemId!==''&&(form.type==='交易完成'||form.type==='订单关闭'||form.type==='已评价')"></el-input>
      </el-form-item>
      ...
      <el-collapse v-model="activeNames">
        <el-collapse-item name="1">
          ...
          <el-form-item label="会员昵称" prop="member.nickname" class="isRequired">
            <el-input v-model="form.member.nickname" :disabled="itemId?true:false" @focus="showDialogFc" placeholder="请选择或添加会员">
        ...
        <el-collapse-item name="2">
          ...
          <el-form-item label="救援机构" prop="orderItems[0].appointment.rescueUnit" v-if="this.$route.params.orderType==='rescue'">
            <el-select v-model="form.orderItems[0].appointment.rescueUnit" placeholder="请选择救援机构">
              <el-option v-for="(rescueOrganization,index) in rescueOrganizations" :key="index" :label="rescueOrganization.name" :value="rescueOrganization.id"></el-option>
            </el-select>
          </el-form-item>
          ...
          <el-form-item label="救援地点" prop="orderItems[0].appointment.workerLocation" v-if="this.$route.params.orderType==='rescue'">
          ...
          <el-form-item label="服务日期" prop="orderItems[0].appointment.appontmentDate" v-if="this.$route.params.orderType==='ride'">
            <el-date-picker
              v-model="form.orderItems[0].appointment.appontmentDate"
              format="yyyy-MM-dd"
          ...
          <el-form-item label="开始时间" prop="orderItems[0].appointment.driveStartDate" v-if="this.$route.params.orderType==='ride'">
            <el-time-picker
              v-model="form.orderItems[0].appointment.driveStartDate"
              format="HH:mm:ss"
              value-format="yyyy-MM-dd HH:mm:ss"
              placeholder="请选择开始时间"
              :disabled="!!itemId&&handler!=='service'"
            ></el-time-picker>
          </el-form-item>
          <el-form-item label="结束时间" prop="orderItems[0].appointment.driveEndDate" v-if="this.$route.params.orderType==='ride'">
            <el-time-picker
              v-model="form.orderItems[0].appointment.driveEndDate"
              format="HH:mm:ss"
              value-format="yyyy-MM-dd HH:mm:ss"
              placeholder="请选择结束时间"
              :disabled="!!itemId&&handler!=='service'"
          ...
          <el-form-item label="结束时间" prop="appointmentEndDate" v-if="this.$route.params.orderType==='service'">
            <el-time-picker
              v-model="form.appointmentEndDate"
              format="HH:mm:ss"
              value-format="yyyy-MM-dd HH:mm:ss"
              placeholder="请选择结束时间"
              :editable="false"
          ...
          <el-form-item label="使用时间(分)" prop="useTime" v-if="this.$route.params.orderType==='ride'">
            <el-input :value="dateInterval(form.orderItems[0].appointment.driveEndDate,form.orderItems[0].appointment.driveStartDate)" :disabled="true"></el-input>
          </el-form-item>
          <el-form-item label="开始里程" prop="orderItems[0].appointment.startMileage" v-if="this.$route.params.orderType==='ride'">
            <el-input-number
              v-model="form.orderItems[0].appointment.startMileage"
              controls-position="right"
              :precision="0"
              :min="0"
              :disabled="!!itemId&&handler!=='service'"
          ...
          <el-form-item label="结束里程" prop="orderItems[0].appointment.endMileage" v-if="this.$route.params.orderType==='ride'">
            <el-input-number
              v-model="form.orderItems[0].appointment.endMileage"
              controls-position="right"
              :precision="0"
              :min="0"
              :disabled="!!itemId&&handler!=='service'"
          ...
          <el-form-item label="使用里程(公里)" v-if="this.$route.params.orderType==='ride'">
            <el-input :value="form.orderItems[0].appointment.endMileage-form.orderItems[0].appointment.startMileage" :disabled="true"></el-input>
          </el-form-item>
          <el-form-item label="体验车号" prop="orderItems[0].appointment.plateNumber" v-if="this.$route.params.orderType==='ride'" class="isRequired">
            <!-- <el-input v-model="form.orderItems[0].appointment.plateNumber" placeholder="请输入试驾车号"></el-input> -->
            <el-autocomplete
              v-model="form.orderItems[0].appointment.plateNumber"
              :fetch-suggestions="querySearchAsync"
              placeholder="请输入体验车号"
              @select="handleSelect"
            ></el-autocomplete>
          </el-form-item>
          <el-form-item label="体验车型" prop="orderItems[0].appointment.product.fullName" v-if="this.$route.params.orderType==='ride'" class="isRequired">
            <el-input v-model="form.orderItems[0].appointment.product.fullName" @focus="queryProduct" placeholder="请选择体验车型"></el-input>
          </el-form-item>
          ...
          <el-form-item label="行驶里程" prop="orderItems[0].appointment.drivingRange" v-if="this.$route.params.orderType==='replace'">
            <el-input-number v-model="form.orderItems[0].appointment.drivingRange" controls-position="right" :min="0"></el-input-number>
          </el-form-item>
          <el-form-item label="上牌时间" prop="orderItems[0].appointment.onTime" v-if="this.$route.params.orderType==='replace'">
            <el-date-picker v-model="form.orderItems[0].appointment.onTime" format="yyyy-MM-dd" value-format="yyyy-MM-dd" type="date" placeholder="选择日期"></el-date-picker>
          </el-form-item>
          <el-form-item
            label="心仪车型"
            prop="orderItems[0].appointment.product.brandId"
            v-if="this.$route.params.orderType==='replace'||this.$route.params.orderType==='loan'"
            class="isRequired"
          >
            <el-select v-model="form.orderItems[0].appointment.product.brandId" placeholder="请选择品牌" filterable style="width: 100%;" @change="handleBrandChange">
              <el-option v-for="(item,index) in brandList" :key="index" :label="item.name" :value="item.id"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item
            label
            prop="orderItems[0].appointment.product.seriesId"
            v-if="this.$route.params.orderType==='replace'||this.$route.params.orderType==='loan'"
            class="isRequired"
          >
            <el-select
              v-model="form.orderItems[0].appointment.product.seriesId"
              placeholder="请选择系列"
              filterable
              style="width: 100%;"
          ...
          <el-form-item
            label
            prop="orderItems[0].appointment.product.id"
            v-if="this.$route.params.orderType==='replace'||this.$route.params.orderType==='loan'"
            class="isRequired"
          >
            <el-select v-model="form.orderItems[0].appointment.product.id" placeholder="请选择车型" style="width: 100%;" @change="productChange" class="isRequired">
          ...
          <el-form-item label="金融方案" prop="orderItems[0].appointment.financialPlan.id" v-if="this.$route.params.orderType==='loan'">
            <el-select
              v-model="form.orderItems[0].appointment.financialPlan.id"
              @change="loanTerm(form.orderItems[0].appointment.financialPlan.id)"
              placeholder="请选择金融方案"
            >
              <el-option v-for="(financialPlan,index) in financialPlans" :key="index" :label="financialPlan.name" :value="financialPlan.id"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="首付比例" prop="orderItems[0].appointment.downPayment" v-if="this.$route.params.orderType==='loan'">
            <el-select v-model="form.orderItems[0].appointment.downPayment" placeholder="请选择首付比例" @change="monthPay">
              <el-option
                v-for="(downPayment,index) in form.orderItems[0].appointment.financialPlan.downPayments"
                :key="index"
                :label="Math.round(downPayment)+'%'"
                :value="downPayment"
              ></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="还款期限" prop="orderItems[0].appointment.year" v-if="this.$route.params.orderType==='loan'">
            <el-select v-model="form.orderItems[0].appointment.year" placeholder="请选择还款年限" @change="monthPay">
              <el-option
                v-for="(loanTerm,index) in form.orderItems[0].appointment.financialPlan.loanTerms"
                :key="index"
                :label="loanTerm.year+'年'"
                :value="loanTerm.year"
              ></el-option>
            </el-select>
          </el-form-item>
          ...
          <el-form-item label="意向购车时间" prop="orderItems[0].appointment.intentionTime" v-if="this.$route.params.orderType==='loan'">
        ...
        <el-collapse-item name="4" v-if="showPayment">
          ...
          <template slot="title" v-if="activeNames.indexOf('4')===-1||!handler">付款信息</template>
        ...
        <el-collapse-item name="5">
          ...
          <el-form-item label="配送方式" prop="shippingMethodName">
            <el-select v-model="form.shippingMethodName" :disabled="itemId?true:false" placeholder="请选择配送方式" @change="onShippingChange">
          ...
          <el-form-item label="零担物流" prop="shippings[0].isLCL" v-if="form.shippingMethodName&&showDelivery">
            <el-switch
              v-model="form.shippings[0].isLCL"
              :disabled="itemId?handler!=='shipping' || isShipped:false"
              active-value="1"
              inactive-value="0"
              active-color="#ff7300"
          ...
          <el-form-item label="物流公司" prop="shippings[0].deliveryCorpId" v-if="form.shippingMethodName&&showDelivery" class="isRequired">
            <el-select
              v-model="form.shippings[0].deliveryCorpId"
              filterable
              :disabled="itemId?handler!=='shipping' || isShipped || form.shippings[0].isLCL==='1':false"
              placeholder="请选择物流公司"
            >
          ...
          <el-form-item label="物流单号" prop="shippings[0].expressSn" v-if="form.shippingMethodName&&showDelivery" class="isRequired">
            <el-input
              v-model="form.shippings[0].expressSn"
              :disabled="itemId?handler!=='shipping' || form.shippings[0].isLCL==='1' || isShipped:false"
              placeholder="请输入物流单号"
            ></el-input>
          </el-form-item>
          ...
          <el-form-item label="收货地址" prop="shippings[0].address" v-if="form.shippingMethodName&&showReceiver" class="isRequired">
            <el-input v-model="form.shippings[0].address" :disabled="itemId?handler!=='shipping' || isShipped:false" placeholder="请输入收货地址"></el-input>
          </el-form-item>
          <el-form-item label="收货人" prop="shippings[0].consignee" v-if="form.shippingMethodName&&showReceiver" class="isRequired">
            <el-input v-model="form.shippings[0].consignee" :disabled="itemId?handler!=='shipping' || isShipped:false" placeholder="请输入收货人"></el-input>
          </el-form-item>
          <el-form-item label="电话" prop="shippings[0].phone" v-if="form.shippingMethodName&&showReceiver" class="isRequired">
            <el-input v-model="form.shippings[0].phone" :disabled="itemId?handler!=='shipping' || isShipped:false" placeholder="请输入电话"></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    save() {
      ...
      if (!this.itemId) {
        if (!this.form.payments[0].paymentType) {
        ...
        if (this.handler === 'shipping') {
          ...
          if (this.showDelivery) {
            ...
            //   return false;
            // }
            if (this.form.shippings[0].deliveryCorpId === '' && this.form.shippings[0].isLCL === '0') {
              this.$message.warning('请输入物流公司');
              this.loading = false;
              return false;
            }
            if (this.form.shippings[0].expressSn === '' && this.form.shippings[0].isLCL === '0') {
            ...
            if (!this.showReceiver) {
              ...
              this.$set(this.form, 'shippingData', {
                isLCL: this.form.shippings[0].isLCL,
