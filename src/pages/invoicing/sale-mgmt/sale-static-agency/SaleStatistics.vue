<template>
  <biz-grid class="purchase-statistics" v-loading="loading">
    ...
    <biz-list v-show="this.activedView==='list'" ref="table" :tableData="tableData" @handleSelectionChange="handleSelectionChange" @rowClick="rowClick" size="small" height="100%">
    ...
    <biz-list v-show="this.activedView==='list1'" ref="table" :tableData="tableDataAgent" @handleSelectionChange="handleSelectionChange" @rowClick="rowClickAgent" size="small" height="100%">
      <el-table-column type="selection" width="50"></el-table-column>
    ...
    <div slot="float">
      ...
      <biz-popup-tabs :open="openAgent" @close="openAgent=false" v-model="tabNameAgent">
        <el-tab-pane label="基本信息" name="baseinfo">
          <base-info-agent :agentId="agentId"></base-info-agent>
        </el-tab-pane>
      </biz-popup-tabs>
    </div>
    <div slot="bottom">
...
export default {
  ...
  methods: {
    ...
    async exportAgentStart() {
      ...
      http
        .post('/admin/invoicing/purchase/agentView/agentSalesReports/exportStart.jhtml', params)
        .then(data => {
    ...
    async exportExcleAgent() {
      try {
        let response = await axios.get('/admin/invoicing/purchase/agentSalesReports/exportResult.jhtml?taskId=' + this.taskId, { responseType: 'blob' });
    ...
    exportStart() {
      ...
      http
        .post('/admin/invoicing/purchase/agentSalesReports/exportStart.jhtml', params)
        .then(data => {
          this.taskId = data.data.taskId;
          this.getProcess(data.data.taskId);
        })
    ...
    getSaleList() {
      ...
      this.loading = true;
      http
        .get('/admin/invoicing/purchase/agentSalesReports.jhtml', params)
        .then(data => {
        ...
        .catch(ErrorData => {
          ...
          this.loading = false;
          if (ErrorData.resultCode === '999') {
            this.sumPurchaseFee = '0';
            this.sumReturnFee = '0';
          }
        })
        .finally(data => {
    ...
    getAgentList() {
      ...
      this.loading = true;
      http
        .get('/admin/invoicing/purchase/agentView/agentSalesReports.jhtml', params)
        .then(data => {
