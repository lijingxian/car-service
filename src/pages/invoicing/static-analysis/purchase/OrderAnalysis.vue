  ...
  <div class="order-analysis">
    ...
    <div class="chart-area" v-loading="loading">
      <div class="graph">
        <div class="filterSeach">
          <div class="filter-area">
            <el-radio-group @change="indicatorChanged" v-model="indicatorValue" size="mini">
              <el-radio-button label="purchaseOrderNum">数量</el-radio-button>
              <el-radio-button label="purchaseOrderState">状态</el-radio-button>
              <el-radio-button label="purchaseOrderAmount">金额</el-radio-button>
              <el-radio-button label="purchaseOrderSupplier">供应商</el-radio-button>
        ...
        <biz-chart :chartData="chartData" :loading="loading" :showSearch="false" v-if="radioValue==='0'&&(indicatorValue==='purchaseOrderNum'||indicatorValue==='purchaseOrderAmount')"></biz-chart>
...
export default {
  ...
  data() {
    return {
      ...
      countTotal: 0,
      radioValue: '0',
      indicatorValue: 'purchaseOrderNum'
    };
  },
  props: {
    params: {
  ...
  methods: {
    ...
    getGraphData() {
      this.loading = true;
      let url = '';
      if (this.indicatorValue === 'purchaseOrderNum' || this.indicatorValue === 'purchaseOrderAmount') {
