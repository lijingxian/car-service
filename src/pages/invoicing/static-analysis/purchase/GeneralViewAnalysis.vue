    ...
    <div slot="top">
      <show-search-grid @refreshHandle="refreshHandle" :showViewType="false">
        <div slot="description" class="description-pover">
          <p>订单分布：统计采购订单状态、供应商的分布以及订单数量和金额的变化趋势</p>
          <p>商品分布：统计采购订单商品的分类分布、商品采购数量排行情况以及商品的采购数量变化趋势</p>
          <p>售后情况：统计采购订单的售后类型、售后频次以及售后率</p>
          <p>供应商分布：供应商供货的订单数量、金额以及供货周期情况</p>
        </div>
      </show-search-grid>
    </div>
    ...
    <div class="total">
      <div class="column1">
        <div class="table-cell">
          订单数
          <div class="color-primary"><span class="font">{{summary.purchaseOrderNum}}</span>单</div>
          <div class="color-primary">
            环比
            <span :style="summary.purchaseOrderNumMon>0?'color:red':'color:green'"><i
                :class="summary.purchaseOrderNumMon>0?'iconfont biz-icon-i-sh-man-pullup':'iconfont biz-icon-i-sh-man-pulldown'"></i>{{summary.purchaseOrderNumMon}}%</span>
            同比
            <span :style="summary.purchaseOrderNumYoy>0?'color:red':'color:green'"><i
                :class="summary.purchaseOrderNumYoy>0?'iconfont biz-icon-i-sh-man-pullup':'iconfont biz-icon-i-sh-man-pulldown'"></i>{{summary.purchaseOrderNumYoy}}%</span>
          </div>
        </div>
      </div>
      <div class="column2">
        <div class="table-cell">
          订单金额
          <div class="color-primary"><span class="font">{{summary.purchaseOrderAmount}}</span>万元</div>
          <div class="color-primary">
            环比
            <span :style="summary.purchaseOrderAmountMon>0?'color:red':'color:green'"><i
                :class="summary.purchaseOrderAmountMon>0?'iconfont biz-icon-i-sh-man-pullup':'iconfont biz-icon-i-sh-man-pulldown'"></i>{{summary.purchaseOrderAmountMon}}%</span>
            同比
            <span :style="summary.purchaseOrderAmountYoy>0?'color:red':'color:green'"><i
                :class="summary.purchaseOrderAmountYoy>0?'iconfont biz-icon-i-sh-man-pullup':'iconfont biz-icon-i-sh-man-pulldown'"></i>{{summary.purchaseOrderAmountYoy}}%</span>
          </div>
        </div>
      </div>
      <div class="column3">
        <div class="table-cell">
          商品数
          <div class="color-primary"><span class="font">{{summary.purchaseProductNum}}</span>个</div>
          <div class="color-primary">
            环比
            <span :style="summary.purchaseProductNumMon>0?'color:red':'color:green'"><i
                :class="summary.purchaseProductNumMon>0?'iconfont biz-icon-i-sh-man-pullup':'iconfont biz-icon-i-sh-man-pulldown'"></i>{{summary.purchaseProductNumMon}}%</span>
            同比
            <span :style="summary.purchaseOrderNumYoy>0?'color:red':'color:green'"><i
                :class="summary.purchaseOrderNumYoy>0?'iconfont biz-icon-i-sh-man-pullup':'iconfont biz-icon-i-sh-man-pulldown'"></i>{{summary.purchaseProductNumYoy}}%</span>
          </div>
        </div>
      </div>
    </div>
