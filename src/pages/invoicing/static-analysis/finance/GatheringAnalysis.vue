  ...
  <div class="supplier-analysis-invoice">
    <div slot="top">
      <show-search-grid @refreshHandle="refreshHandle" ref="search">
        <div slot="description" class="description-pover">
          <p>业务类型：统计收付款业务类型分布</p>
          <p>支付方式：统计收付款支付方式分布</p>
          <p>收款方式：统计收付款付款方式分布</p>
        </div>
      </show-search-grid>
    </div>
    ...
    <div class="chart-area" v-loading="loading">
      <div class="graph">
        <div class="filterSeach">
          <div class="filter-area">
            <el-radio-group @change="indicatorChanged" v-model="indicatorValue" size="mini">
              <el-radio-button label="paymentMethod">支付方式</el-radio-button>
              <el-radio-button label="businessType">业务类型</el-radio-button>
              <el-radio-button label="paymentType">收款方式</el-radio-button>
            </el-radio-group>
          </div>
        ...
        <div class="content" style="width:40%;float:right;line-height:40px;font-size: 13px;padding:100px;height:600px;overflow:auto" v-show="radioValue==='0'">
      ...
      <biz-list ref="list" :height="height" :tableData="tableData" style="width: 100%;height:100%" v-show="radioValue==='1'">
          ...
          <el-table-column prop="billType" label="收（付）款"></el-table-column>
          <el-table-column prop="type" label="业务类型"></el-table-column>
          <el-table-column prop="relateUnitName" label="往来方"></el-table-column>
          <el-table-column prop="amount" label="金额"></el-table-column>
          <el-table-column prop="relateBillSn" label="关联单据"></el-table-column>
          <el-table-column prop="paymentMethodName" label="支付方式"></el-table-column>
