      ...
      filters: [
        {
          ...
          value: 'product',
          options: [
            { value: 'product', label: '精品', type: 'product' },
            { value: 'finance', label: '金融', type: 'finance' },
            { value: 'insurance', label: '保险', type: 'insurance' }
          ]
        }
      ],
      kpiName: ['本期', '同比', '环比'],
  ...
  methods: {
    ...
    getGraphData() {
      ...
      let params = {
        ...
        orderTypes: [this.filters[0].value],
    ...
    async exportExcle() {
      ...
      try {
        let response = await axios.post('/admin/ecommerce/kpi/sales/export/userOrder.jhtml', params, { responseType: 'blob' });
