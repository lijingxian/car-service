    ...
    <div class="chart-area">
      <div class="graph">
        ...
        <biz-list ref="list" :height="height" :tableData="tableData" style="width: 100%" v-if="!isShow">
          ...
          <el-table-column prop="complateDate" label="订单完成时间"></el-table-column>
          <el-table-column label="商品信息" prop="productName" min-width="180">
          </el-table-column>
          <el-table-column prop="orderAmount" label="订单金额"></el-table-column>
          <el-table-column prop="salesAdvisor" label="顾问">
          </el-table-column>
        </biz-list>
...
export default {
      ...
      filters: [
        {
          type: 'single',
          label: '',
          value: 'orderProductNum',
          options: [
            { value: 'orderProductNum', label: '销售台次', type: 'car' },
            { value: 'orderNum', label: '订单数', type: 'car' },
            { value: 'orderProductAvgNum', label: '人均销售台次' }
          ]
        }
      ],
      kpiName: ['本期', '同比', '环比'],
  ...
  methods: {
    ...
    getTable() {
      ...
      http
        .post('/admin/ecommerce/kpi/sales/table/userOrder.jhtml', params)
        .then(data => {
    ...
    exportStart() {
      ...
      http
        .post('/admin/ecommerce/kpi/sales/export/userOrder/exportStart.jhtml', params)
        .then(data => {
    ...
    async exportExcle() {
      try {
        let response = await axios.get('/admin/ecommerce/kpi/sales/export/userOrder/exportResult.jhtml?taskId=' + this.taskId, { responseType: 'blob' });
