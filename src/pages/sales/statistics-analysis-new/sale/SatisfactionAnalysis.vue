    ...
    <div class="chart-area">
      <div class="graph">
        ...
        <biz-list ref="list" :height="height" :tableData="tableData" style="width: 100%" v-if="!isShow">
          ...
          <el-table-column prop="satisfaction" label="服务满意度" v-if="filters[0].value==='satisfaction'"></el-table-column>
          <el-table-column prop="serviceAttitude" label="服务态度" v-if="filters[0].value==='serviceAttitude'"></el-table-column>
          <el-table-column prop="serviceSpeed" label="服务速度" v-if="filters[0].value==='serviceSpeed'"></el-table-column>
          <el-table-column prop="professional" label="专业技能" v-if="filters[0].value==='professional'"></el-table-column>
        </biz-list>
      ...
      filters: [
        {
          ...
          value: 'satisfaction',
          options: [
            { value: 'satisfaction', label: '服务满意度' },
