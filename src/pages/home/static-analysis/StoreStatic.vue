    ...
    <div class="card">
      <el-card class="box-card">
        ...
        <div class="box-div">
          ...
          <span class="color">
            {{statistics.product?statistics.product.product:''}}
          </span>
        </div>
      </el-card>
      <el-card class="box-card">
        ...
        <div class="box-div">
          ...
          <span class="color">
            {{statistics.content?statistics.content.article:''}}
          </span>
        </div>
      </el-card>
    </div>
