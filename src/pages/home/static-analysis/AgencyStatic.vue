  ...
  <div class="warehouse-static">
    ...
    <div class="card">
      <el-card class="box-card">
        <div class="box-div">
          <span class="font" :class="{yellow:indicators==='purchaseOrder'}" @click="init('purchaseOrder')">采购订单数</span>
          <span class="color">
            {{statistics.order?statistics.order.purchaseOrder:''}}
          </span>
        </div>
        <div class="box-div">
          <span class="font" :class="{yellow:indicators==='purchaseOrderAmount'}" @click="init('purchaseOrderAmount')">采购订单金额(万)</span>
          <span class="color">
            {{statistics.order?statistics.order.purchaseOrderAmount:''}}
          </span>
        </div>
      </el-card>
    </div>
  ...
  methods: {
    ...
    init(indicator) {
      ...
      let params = {
        ...
        indicator: indicator || 'purchaseOrder',
        roleType: '24'
      };
      http
