  ...
  <div class="afterSale-static">
    ...
    <div class="card">
      <el-card class="box-card">
        <div class="box-div">
          <span class="font" :class="{yellow:indicators==='testDriverNumInc'}" @click="init('testDriverNumInc')">新增试驾数</span>
          <span class="color">
            {{statistics.testDriver?statistics.testDriver.testDriverNumInc:''}}
          </span>
        </div>
        <div class="box-div">
          <span class="font" :class="{yellow:indicators==='testDriverNumCnt'}" @click="init('testDriverNumCnt')">累计试驾数</span>
          <span class="color">
            {{statistics.testDriver?statistics.testDriver.testDriverNumCnt:''}}
          </span>
        </div>
      </el-card>
    </div>
  ...
  methods: {
    ...
    init(indicator) {
      ...
      let params = {
        ...
        indicator: indicator || 'testDriverNumInc',
        roleType: '8'
      };
      http
