  ...
  <div class="rescue-static">
    ...
    <div class="card">
      <el-card class="box-card">
        <div class="box-div">
          <span class="font" :class="{yellow:indicators==='rescue'}" @click="init('rescue')">新增救援订单</span>
          <span class="color">
            {{statistics.rescue?statistics.rescue.rescue:''}}
          </span>
        </div>
        <div class="box-div">
        ...
        <div class="box-div">
          <span class="font" :class="{yellow:indicators==='cancelRescue'}" @click="init('cancelRescue')">取消救援订单</span>
          <span class="color">
            {{statistics.rescue?statistics.rescue.cancelRescue:''}}
          </span>
        </div>
      </el-card>
    </div>
