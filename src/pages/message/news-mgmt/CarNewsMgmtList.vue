<template>
  <biz-grid class="news-mgmt">
    <biz-header :operations="operations" @operate="operate" slot="top" :filters="filters" @filterDataChange="filterDataChange">
    </biz-header>
      ...
      <el-table-column prop="date" label="操作" min-width="60">
        <div slot-scope="scope">
          ...
          <div class="biz-customcol" v-else>
            <el-button type="text" size="mini" @click.stop="handler(scope.row)" v-if="category==='pendingRemind'">处理</el-button>
