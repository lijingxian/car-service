...
// 店铺宣传
const ShopPublicitySys = resolve =>
  require(['@/pages/marketing/content-mgmt/shop-publicity-sys/ShopPublicity'], resolve);
// 商品推广
...
const enter = [
  ...
  // 店铺推广-平台
  {
    path: 'marketing-mgmt/shop-publicity-sys',
    component: ShopPublicitySys
  },
  // 商品宣传
  {
